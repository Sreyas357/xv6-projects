...
80100028:	bc 50 73 11 80       	mov    $0x80117350,%esp
...
8010041f:	e8 5c 5a 00 00       	call   80105e80 <uartputc>
...
801004ea:	e8 91 59 00 00       	call   80105e80 <uartputc>
801004ef:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
801004f6:	e8 85 59 00 00       	call   80105e80 <uartputc>
801004fb:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
80100502:	e8 79 59 00 00       	call   80105e80 <uartputc>
...
801005a3:	68 85 73 10 80       	push   $0x80107385
...
8010064b:	0f b6 92 b0 73 10 80 	movzbl -0x7fef8c50(%edx),%edx
...
80100762:	b9 28 00 00 00       	mov    $0x28,%ecx
        s = "(null)";
80100767:	bf 98 73 10 80       	mov    $0x80107398,%edi
...
801008b5:	68 9f 73 10 80       	push   $0x8010739f
...
80100a96:	68 a8 73 10 80       	push   $0x801073a8
...
80100b44:	0f 85 f1 00 00 00    	jne    80100c3b <exec+0x15b>
  ...
  if((pgdir = setupkvm()) == 0)
80100b4a:	e8 a1 64 00 00       	call   80106ff0 <setupkvm>
...
80100bbb:	e8 60 62 00 00       	call   80106e20 <allocuvm>
...
80100bf1:	e8 5a 61 00 00       	call   80106d50 <loaduvm>
...
80100c33:	e8 38 63 00 00       	call   80106f70 <freevm>
  if(ip){
...
80100c92:	e8 89 61 00 00       	call   80106e20 <allocuvm>
...
80100cb1:	31 f6                	xor    %esi,%esi
  clearpteu(pgdir, (char*)(sz - 2*PGSIZE));
80100cb3:	e8 d8 63 00 00       	call   80107090 <clearpteu>
  for(argc = 0; argv[argc]; argc++) {
...
80100d1e:	e8 3d 65 00 00       	call   80107260 <copyout>
...
80100d8f:	e8 cc 64 00 00       	call   80107260 <copyout>
...
80100dfb:	e8 c0 5d 00 00       	call   80106bc0 <switchuvm>
  freevm(oldpgdir);
80100e00:	89 34 24             	mov    %esi,(%esp)
80100e03:	e8 68 61 00 00       	call   80106f70 <freevm>
  return 0;
...
80100e4a:	68 c1 73 10 80       	push   $0x801073c1
...
80100e66:	68 cd 73 10 80       	push   $0x801073cd
...
80100f2b:	68 d4 73 10 80       	push   $0x801073d4
...
8010100c:	68 dc 73 10 80       	push   $0x801073dc
...
801010f2:	68 e6 73 10 80       	push   $0x801073e6
...
801011c7:	68 ef 73 10 80       	push   $0x801073ef
...
80101201:	68 f5 73 10 80       	push   $0x801073f5
...
80101219:	8b 0d 2c 34 11 80    	mov    0x8011342c,%ecx
{
...
80101236:	03 05 44 34 11 80    	add    0x80113444,%eax
...
8010124e:	a1 2c 34 11 80       	mov    0x8011342c,%eax
...
801012aa:	3b 3d 2c 34 11 80    	cmp    0x8011342c,%edi
801012b0:	0f 82 76 ff ff ff    	jb     8010122c <balloc+0x1c>
  }
  panic("balloc: out of blocks");
801012b6:	83 ec 0c             	sub    $0xc,%esp
801012b9:	68 ff 73 10 80       	push   $0x801073ff
...
80101352:	74 6c                	je     801013c0 <iget+0xa0>
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
80101354:	81 c3 2c 01 00 00    	add    $0x12c,%ebx
8010135a:	81 fb 2c 34 11 80    	cmp    $0x8011342c,%ebx
...
80101371:	89 df                	mov    %ebx,%edi
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
80101373:	81 c3 2c 01 00 00    	add    $0x12c,%ebx
80101379:	81 fb 2c 34 11 80    	cmp    $0x8011342c,%ebx
...
801013e6:	c3                   	ret
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
801013e7:	81 c3 2c 01 00 00    	add    $0x12c,%ebx
801013ed:	81 fb 2c 34 11 80    	cmp    $0x8011342c,%ebx
...
80101408:	68 15 74 10 80       	push   $0x80107415
...
8010142b:	53                   	push   %ebx
  bp = bread(dev, BBLOCK(b, sb));
8010142c:	03 05 44 34 11 80    	add    0x80113444,%eax
{
...
80101487:	68 25 74 10 80       	push   $0x80107425
...
80101565:	68 38 74 10 80       	push   $0x80107438
...
801015bc:	68 4b 74 10 80       	push   $0x8010744b
...
801015d3:	68 52 74 10 80       	push   $0x80107452
801015d8:	53                   	push   %ebx
  for(i = 0; i < NINODE; i++) {
801015d9:	81 c3 2c 01 00 00    	add    $0x12c,%ebx
    initsleeplock(&icache.inode[i].lock, "inode");
801015df:	e8 2c 2d 00 00       	call   80104310 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
801015e4:	83 c4 10             	add    $0x10,%esp
801015e7:	81 fb 38 34 11 80    	cmp    $0x80113438,%ebx
...
80101607:	68 2c 34 11 80       	push   $0x8011342c
...
80101619:	ff 35 44 34 11 80    	push   0x80113444
8010161f:	ff 35 40 34 11 80    	push   0x80113440
80101625:	ff 35 3c 34 11 80    	push   0x8011343c
8010162b:	ff 35 38 34 11 80    	push   0x80113438
80101631:	ff 35 34 34 11 80    	push   0x80113434
80101637:	ff 35 30 34 11 80    	push   0x80113430
8010163d:	ff 35 2c 34 11 80    	push   0x8011342c
80101643:	68 b8 74 10 80       	push   $0x801074b8
...
8010166c:	83 3d 34 34 11 80 01 	cmpl   $0x1,0x80113434
{
...
8010169f:	3b 3d 34 34 11 80    	cmp    0x80113434,%edi
...
801016af:	03 05 40 34 11 80    	add    0x80113440,%eax
...
80101713:	68 58 74 10 80       	push   $0x80107458
...
80101734:	03 05 40 34 11 80    	add    0x80113440,%eax
...
80101819:	03 05 40 34 11 80    	add    0x80113440,%eax
...
8010188d:	68 70 74 10 80       	push   $0x80107470
80101892:	e8 e9 ea ff ff       	call   80100380 <panic>
    panic("ilock");
80101897:	83 ec 0c             	sub    $0xc,%esp
8010189a:	68 6a 74 10 80       	push   $0x8010746a
...
801018e7:	68 7f 74 10 80       	push   $0x8010747f
...
80101aa3:	68 7f 74 10 80       	push   $0x8010747f
...
80101dc2:	68 99 74 10 80       	push   $0x80107499
80101dc7:	e8 b4 e5 ff ff       	call   80100380 <panic>
    panic("dirlookup not DIR");
80101dcc:	83 ec 0c             	sub    $0xc,%esp
80101dcf:	68 87 74 10 80       	push   $0x80107487
...
8010202e:	68 7f 74 10 80       	push   $0x8010747f
...
801020db:	68 a8 74 10 80       	push   $0x801074a8
801020e0:	e8 9b e2 ff ff       	call   80100380 <panic>
    panic("dirlink");
801020e5:	83 ec 0c             	sub    $0xc,%esp
801020e8:	68 82 7a 10 80       	push   $0x80107a82
...
801021fb:	68 14 75 10 80       	push   $0x80107514
80102200:	e8 7b e1 ff ff       	call   80100380 <panic>
    panic("idestart");
80102205:	83 ec 0c             	sub    $0xc,%esp
80102208:	68 0b 75 10 80       	push   $0x8010750b
...
80102226:	68 26 75 10 80       	push   $0x80107526
8010222b:	68 80 34 11 80       	push   $0x80113480
80102230:	e8 0b 22 00 00       	call   80104440 <initlock>
  ioapicenable(IRQ_IDE, ncpu - 1);
80102235:	58                   	pop    %eax
80102236:	a1 04 36 11 80       	mov    0x80113604,%eax
8010223b:	5a                   	pop    %edx
...
80102288:	74 f6                	je     80102280 <ideinit+0x60>
      havedisk1 = 1;
8010228a:	c7 05 60 34 11 80 01 	movl   $0x1,0x80113460
80102291:	00 00 00 
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
...
801022b6:	83 ec 18             	sub    $0x18,%esp
  ...
  acquire(&idelock);
801022b9:	68 80 34 11 80       	push   $0x80113480
801022be:	e8 5d 23 00 00       	call   80104620 <acquire>

  if((b = idequeue) == 0){
801022c3:	8b 1d 64 34 11 80    	mov    0x80113464,%ebx
...
801022d3:	a3 64 34 11 80       	mov    %eax,0x80113464
...
8010231d:	e8 4e 1e 00 00       	call   80104170 <wakeup>
  ...
  if(idequeue != 0)
80102322:	a1 64 34 11 80       	mov    0x80113464,%eax
...
80102336:	68 80 34 11 80       	push   $0x80113480
...
80102383:	a1 60 34 11 80       	mov    0x80113460,%eax
...
80102393:	68 80 34 11 80       	push   $0x80113480
80102398:	e8 83 22 00 00       	call   80104620 <acquire>

  // Append b to idequeue.
  b->qnext = 0;
  for(pp=&idequeue; *pp; pp=&(*pp)->qnext)  //DOC:insert-queue
8010239d:	a1 64 34 11 80       	mov    0x80113464,%eax
  b->qnext = 0;
...
801023bc:	89 1a                	mov    %ebx,(%edx)
  ...
  if(idequeue == b)
801023be:	39 1d 64 34 11 80    	cmp    %ebx,0x80113464
...
801023d3:	68 80 34 11 80       	push   $0x80113480
...
801023e9:	75 e5                	jne    801023d0 <iderw+0x80>
  ...
  release(&idelock);
801023eb:	c7 45 08 80 34 11 80 	movl   $0x80113480,0x8(%ebp)
}
...
80102445:	c7 05 b4 34 11 80 00 	movl   $0xfec00000,0x801134b4
8010244c:	00 c0 fe 
  ioapic->reg = reg;
8010244f:	c7 05 00 00 c0 fe 01 	movl   $0x1,0xfec00000
80102456:	00 00 00 
  return ioapic->data;
80102459:	8b 15 b4 34 11 80    	mov    0x801134b4,%edx
8010245f:	8b 72 10             	mov    0x10(%edx),%esi
  ioapic->reg = reg;
80102462:	c7 02 00 00 00 00    	movl   $0x0,(%edx)
  return ioapic->data;
80102468:	8b 1d b4 34 11 80    	mov    0x801134b4,%ebx
  maxintr = (ioapicread(REG_VER) >> 16) & 0xFF;
  id = ioapicread(REG_ID) >> 24;
  if(id != ioapicid)
8010246e:	0f b6 15 00 36 11 80 	movzbl 0x80113600,%edx
  maxintr = (ioapicread(REG_VER) >> 16) & 0xFF;
...
8010248a:	68 74 75 10 80       	push   $0x80107574
8010248f:	e8 1c e2 ff ff       	call   801006b0 <cprintf>
  ioapic->reg = reg;
80102494:	8b 1d b4 34 11 80    	mov    0x801134b4,%ebx
...
801024aa:	8d 48 20             	lea    0x20(%eax),%ecx
  ioapic->data = data;
801024ad:	8b 1d b4 34 11 80    	mov    0x801134b4,%ebx
...
801024c5:	89 0b                	mov    %ecx,(%ebx)
  ioapic->data = data;
801024c7:	8b 1d b4 34 11 80    	mov    0x801134b4,%ebx
...
801024e0:	55                   	push   %ebp
  ioapic->reg = reg;
801024e1:	8b 0d b4 34 11 80    	mov    0x801134b4,%ecx
{
...
801024f3:	89 01                	mov    %eax,(%ecx)
  ioapic->data = data;
801024f5:	8b 0d b4 34 11 80    	mov    0x801134b4,%ecx
...
80102504:	89 01                	mov    %eax,(%ecx)
  ioapic->data = data;
80102506:	a1 b4 34 11 80       	mov    0x801134b4,%eax
  ioapicwrite(REG_TABLE+2*irq+1, cpunum << 24);
...
80102532:	81 fb 50 73 11 80    	cmp    $0x80117350,%ebx
...
80102552:	e8 a9 21 00 00       	call   80104700 <memset>
  ...
  if(kmem.use_lock)
80102557:	8b 15 f4 34 11 80    	mov    0x801134f4,%edx
...
80102564:	a1 f8 34 11 80       	mov    0x801134f8,%eax
80102569:	89 03                	mov    %eax,(%ebx)
  kmem.freelist = r;
  if(kmem.use_lock)
8010256b:	a1 f4 34 11 80       	mov    0x801134f4,%eax
  kmem.freelist = r;
80102570:	89 1d f8 34 11 80    	mov    %ebx,0x801134f8
  if(kmem.use_lock)
...
80102583:	68 c0 34 11 80       	push   $0x801134c0
...
80102592:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    release(&kmem.lock);
80102598:	c7 45 08 c0 34 11 80 	movl   $0x801134c0,0x8(%ebp)
}
...
801025ab:	68 a6 75 10 80       	push   $0x801075a6
...
80102652:	73 e4                	jae    80102638 <kinit2+0x28>
  kmem.use_lock = 1;
80102654:	c7 05 f4 34 11 80 01 	movl   $0x1,0x801134f4
8010265b:	00 00 00 
}
...
8010267b:	68 ac 75 10 80       	push   $0x801075ac
80102680:	68 c0 34 11 80       	push   $0x801134c0
...
8010268d:	83 c4 10             	add    $0x10,%esp
  kmem.use_lock = 0;
80102690:	c7 05 f4 34 11 80 00 	movl   $0x0,0x801134f4
80102697:	00 00 00 
  p = (char*)PGROUNDUP((uint)vstart);
...
80102713:	68 c0 34 11 80       	push   $0x801134c0
80102718:	e8 03 1f 00 00       	call   80104620 <acquire>
  r = kmem.freelist;
8010271d:	8b 1d f8 34 11 80    	mov    0x801134f8,%ebx
  if(kmem.use_lock)
80102723:	a1 f4 34 11 80       	mov    0x801134f4,%eax
  if(r)
...
80102777:	ec                   	in     (%dx),%al
  ...
  if(data == 0xE0){
    shift |= E0ESC;
80102778:	8b 1d fc 34 11 80    	mov    0x801134fc,%ebx
  data = inb(KBDATAP);
...
8010279b:	0f b6 91 e0 76 10 80 	movzbl -0x7fef8920(%ecx),%edx
  shift ^= togglecode[data];
801027a2:	0f b6 81 e0 75 10 80 	movzbl -0x7fef8a20(%ecx),%eax
  shift |= shiftcode[data];
...
801027ad:	89 d0                	mov    %edx,%eax
  shift ^= togglecode[data];
801027af:	89 15 fc 34 11 80    	mov    %edx,0x801134fc
  c = charcode[shift & (CTL | SHIFT)][data];
801027b5:	83 e0 03             	and    $0x3,%eax
  if(shift & CAPSLOCK){
801027b8:	83 e2 08             	and    $0x8,%edx
  c = charcode[shift & (CTL | SHIFT)][data];
801027bb:	8b 04 85 c0 75 10 80 	mov    -0x7fef8a40(,%eax,4),%eax
...
801027e2:	83 c8 40             	or     $0x40,%eax
    shift &= ~(shiftcode[data] | E0ESC);
801027e5:	a3 fc 34 11 80       	mov    %eax,0x801134fc
}
...
801027fd:	0f 44 c8             	cmove  %eax,%ecx
    shift &= ~(shiftcode[data] | E0ESC);
80102800:	0f b6 81 e0 76 10 80 	movzbl -0x7fef8920(%ecx),%eax
...
{
  if(!lapic)
80102860:	a1 00 35 11 80       	mov    0x80113500,%eax
...
{
  if (!lapic)
80102960:	a1 00 35 11 80       	mov    0x80113500,%eax
...
{
  if(lapic)
80102980:	a1 00 35 11 80       	mov    0x80113500,%eax
...
801029e8:	66 a3 69 04 00 80    	mov    %ax,0x80000469
  lapic[index] = value;
801029ee:	a1 00 35 11 80       	mov    0x80113500,%eax
...
80102c30:	8b 0d 68 35 11 80    	mov    0x80113568,%ecx
...
80102cb4:	39 3d 68 35 11 80    	cmp    %edi,0x80113568
...
80102cd7:	ff 35 54 35 11 80    	push   0x80113554
80102cdd:	ff 35 64 35 11 80    	push   0x80113564
...
80102ceb:	89 c3                	mov    %eax,%ebx
  hb->n = log.lh.n;
80102ced:	a1 68 35 11 80       	mov    0x80113568,%eax
...
80102d00:	8b 0c 95 6c 35 11 80 	mov    -0x7feeca94(,%edx,4),%ecx
...
80102d3a:	68 e0 77 10 80       	push   $0x801077e0
80102d3f:	68 20 35 11 80       	push   $0x80113520
...
80102d58:	59                   	pop    %ecx
  log.dev = dev;
80102d59:	89 1d 64 35 11 80    	mov    %ebx,0x80113564
  log.size = sb.nlog;
80102d5f:	8b 55 e8             	mov    -0x18(%ebp),%edx
  log.start = sb.logstart;
80102d62:	a3 54 35 11 80       	mov    %eax,0x80113554
  log.size = sb.nlog;
80102d67:	89 15 58 35 11 80    	mov    %edx,0x80113558
  struct buf *buf = bread(log.dev, log.start);
80102d6d:	5a                   	pop    %edx
...
80102d7b:	89 1d 68 35 11 80    	mov    %ebx,0x80113568
  for (i = 0; i < log.lh.n; i++) {
...
80102d94:	89 0c 95 6c 35 11 80 	mov    %ecx,-0x7feeca94(,%edx,4)
  for (i = 0; i < log.lh.n; i++) {
...
80102dab:	e8 80 fe ff ff       	call   80102c30 <install_trans>
  log.lh.n = 0;
80102db0:	c7 05 68 35 11 80 00 	movl   $0x0,0x80113568
80102db7:	00 00 00 
...
80102dd3:	83 ec 14             	sub    $0x14,%esp
  acquire(&log.lock);
80102dd6:	68 20 35 11 80       	push   $0x80113520
...
80102deb:	68 20 35 11 80       	push   $0x80113520
80102df0:	68 20 35 11 80       	push   $0x80113520
80102df5:	e8 b6 12 00 00       	call   801040b0 <sleep>
80102dfa:	83 c4 10             	add    $0x10,%esp
    if(log.committing){
80102dfd:	a1 60 35 11 80       	mov    0x80113560,%eax
80102e02:	85 c0                	test   %eax,%eax
80102e04:	75 e2                	jne    80102de8 <begin_op+0x18>
    } else if(log.lh.n + (log.outstanding+1)*MAXOPBLOCKS > LOGSIZE){
80102e06:	a1 5c 35 11 80       	mov    0x8011355c,%eax
80102e0b:	8b 15 68 35 11 80    	mov    0x80113568,%edx
...
80102e1f:	83 ec 0c             	sub    $0xc,%esp
      log.outstanding += 1;
80102e22:	a3 5c 35 11 80       	mov    %eax,0x8011355c
      release(&log.lock);
80102e27:	68 20 35 11 80       	push   $0x80113520
...
80102e46:	83 ec 18             	sub    $0x18,%esp
  ...
  acquire(&log.lock);
80102e49:	68 20 35 11 80       	push   $0x80113520
80102e4e:	e8 cd 17 00 00       	call   80104620 <acquire>
  log.outstanding -= 1;
80102e53:	a1 5c 35 11 80       	mov    0x8011355c,%eax
  if(log.committing)
80102e58:	8b 35 60 35 11 80    	mov    0x80113560,%esi
80102e5e:	83 c4 10             	add    $0x10,%esp
  log.outstanding -= 1;
80102e61:	8d 58 ff             	lea    -0x1(%eax),%ebx
80102e64:	89 1d 5c 35 11 80    	mov    %ebx,0x8011355c
  if(log.committing)
...
80102e74:	0f 85 f6 00 00 00    	jne    80102f70 <end_op+0x130>
    do_commit = 1;
    log.committing = 1;
80102e7a:	c7 05 60 35 11 80 01 	movl   $0x1,0x80113560
80102e81:	00 00 00 
...
80102e87:	68 20 35 11 80       	push   $0x80113520
...
{
  if (log.lh.n > 0) {
80102e91:	8b 0d 68 35 11 80    	mov    0x80113568,%ecx
...
80102ea1:	68 20 35 11 80       	push   $0x80113520
80102ea6:	e8 75 17 00 00       	call   80104620 <acquire>
    log.committing = 0;
80102eab:	c7 05 60 35 11 80 00 	movl   $0x0,0x80113560
80102eb2:	00 00 00 
    wakeup(&log);
80102eb5:	c7 04 24 20 35 11 80 	movl   $0x80113520,(%esp)
80102ebc:	e8 af 12 00 00       	call   80104170 <wakeup>
    release(&log.lock);
80102ec1:	c7 04 24 20 35 11 80 	movl   $0x80113520,(%esp)
...
80102f44:	3b 1d 68 35 11 80    	cmp    0x80113568,%ebx
...
80102f51:	e8 da fc ff ff       	call   80102c30 <install_trans>
    log.lh.n = 0;
80102f56:	c7 05 68 35 11 80 00 	movl   $0x0,0x80113568
80102f5d:	00 00 00 
...
80102f73:	68 20 35 11 80       	push   $0x80113520
80102f78:	e8 f3 11 00 00       	call   80104170 <wakeup>
  release(&log.lock);
80102f7d:	c7 04 24 20 35 11 80 	movl   $0x80113520,(%esp)
...
80102f97:	68 e4 77 10 80       	push   $0x801077e4
...
80102fdd:	68 20 35 11 80       	push   $0x80113520
...
80102fef:	8b 15 68 35 11 80    	mov    0x80113568,%edx
...
80103005:	74 29                	je     80103030 <log_write+0x80>
    if (log.lh.block[i] == b->blockno)   // log absorbtion
80103007:	39 0c 85 6c 35 11 80 	cmp    %ecx,-0x7feeca94(,%eax,4)
8010300e:	75 f0                	jne    80103000 <log_write+0x50>
      break;
  }
  log.lh.block[i] = b->blockno;
80103010:	89 0c 85 6c 35 11 80 	mov    %ecx,-0x7feeca94(,%eax,4)
  if (i == log.lh.n)
...
8010301e:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  release(&log.lock);
80103021:	c7 45 08 20 35 11 80 	movl   $0x80113520,0x8(%ebp)
}
80103028:	c9                   	leave
  release(&log.lock);
...
8010302e:	66 90                	xchg   %ax,%ax
  log.lh.block[i] = b->blockno;
80103030:	89 0c 95 6c 35 11 80 	mov    %ecx,-0x7feeca94(,%edx,4)
    log.lh.n++;
80103037:	83 c2 01             	add    $0x1,%edx
8010303a:	89 15 68 35 11 80    	mov    %edx,0x80113568
80103040:	eb d9                	jmp    8010301b <log_write+0x6b>
    panic("too big a transaction");
80103042:	83 ec 0c             	sub    $0xc,%esp
80103045:	68 f3 77 10 80       	push   $0x801077f3
8010304a:	e8 31 d3 ff ff       	call   80100380 <panic>
    panic("log_write outside of trans");
8010304f:	83 ec 0c             	sub    $0xc,%esp
80103052:	68 09 78 10 80       	push   $0x80107809
...
80103078:	68 24 78 10 80       	push   $0x80107824
8010307d:	e8 2e d6 ff ff       	call   801006b0 <cprintf>
  idtinit();       // load idt register
80103082:	e8 19 2a 00 00       	call   80105aa0 <idtinit>
...
801030a3:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
801030a6:	e8 05 3b 00 00       	call   80106bb0 <switchkvm>
  seginit();
801030ab:	e8 70 3a 00 00       	call   80106b20 <seginit>
  lapicinit();
...
80103104:	e8 87 2c 00 00       	call   80105d90 <uartinit>
  pinit();         // process table
80103109:	e8 42 08 00 00       	call   80103950 <pinit>
  tvinit();        // trap vectors
8010310e:	e8 0d 29 00 00       	call   80105a20 <tvinit>
  binit();         // buffer cache
...
8010313c:	69 05 04 36 11 80 b0 	imul   $0xb0,0x80113604,%eax
80103143:	00 00 00 
80103146:	05 20 36 11 80       	add    $0x80113620,%eax
8010314b:	3d 20 36 11 80       	cmp    $0x80113620,%eax
80103150:	76 7e                	jbe    801031d0 <main+0x110>
80103152:	bb 20 36 11 80       	mov    $0x80113620,%ebx
80103157:	eb 20                	jmp    80103179 <main+0xb9>
80103159:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80103160:	69 05 04 36 11 80 b0 	imul   $0xb0,0x80113604,%eax
80103167:	00 00 00 
8010316a:	81 c3 b0 00 00 00    	add    $0xb0,%ebx
80103170:	05 20 36 11 80       	add    $0x80113620,%eax
...
8010321e:	68 38 78 10 80       	push   $0x80107838
...
801032d9:	68 3d 78 10 80       	push   $0x8010783d
...
80103339:	89 5d e4             	mov    %ebx,-0x1c(%ebp)
  lapic = (uint*)conf->lapicaddr;
8010333c:	a3 00 35 11 80       	mov    %eax,0x80113500
  for(p=(uchar*)(conf+1), e=(uchar*)conf+conf->length; p<e; ){
...
801033c4:	83 c0 08             	add    $0x8,%eax
      ioapicid = ioapic->apicno;
801033c7:	88 0d 00 36 11 80    	mov    %cl,0x80113600
      continue;
801033cd:	eb 91                	jmp    80103360 <mpinit+0xf0>
801033cf:	90                   	nop
      if(ncpu < NCPU) {
801033d0:	8b 0d 04 36 11 80    	mov    0x80113604,%ecx
...
801033e8:	89 0d 04 36 11 80    	mov    %ecx,0x80113604
        cpus[ncpu].apicid = proc->apicid;  // apicid may differ from ncpu
801033ee:	88 9f 20 36 11 80    	mov    %bl,-0x7feec9e0(%edi)
...
80103403:	68 42 78 10 80       	push   $0x80107842
...
80103432:	68 38 78 10 80       	push   $0x80107838
...
80103468:	68 5c 78 10 80       	push   $0x8010785c
...
80103510:	00 00 00 
  initlock(&p->lock, "pipe");
80103513:	68 7b 78 10 80       	push   $0x8010787b
...
80103834:	bb d4 3b 11 80       	mov    $0x80113bd4,%ebx
{
80103839:	83 ec 10             	sub    $0x10,%esp
  acquire(&ptable.lock);
8010383c:	68 a0 3b 11 80       	push   $0x80113ba0
...
80103853:	81 fb d4 5a 11 80    	cmp    $0x80115ad4,%ebx
...
8010386a:	c7 43 0c 01 00 00 00 	movl   $0x1,0xc(%ebx)
  p->pid = nextpid++;
80103871:	89 43 10             	mov    %eax,0x10(%ebx)
80103874:	8d 50 01             	lea    0x1(%eax),%edx
  release(&ptable.lock);
80103877:	68 a0 3b 11 80       	push   $0x80113ba0
  p->pid = nextpid++;
8010387c:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
...
801038a4:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
801038a7:	c7 40 14 12 5a 10 80 	movl   $0x80105a12,0x14(%eax)
  p->context = (struct context*)sp;
...
801038d3:	31 db                	xor    %ebx,%ebx
  release(&ptable.lock);
801038d5:	68 a0 3b 11 80       	push   $0x80113ba0
...
80103903:	83 ec 14             	sub    $0x14,%esp
  ...
  release(&ptable.lock);
80103906:	68 a0 3b 11 80       	push   $0x80113ba0
...
80103956:	68 80 78 10 80       	push   $0x80107880
8010395b:	68 a0 3b 11 80       	push   $0x80113ba0
...
8010397c:	e8 df ef ff ff       	call   80102960 <lapicid>
  for (i = 0; i < ncpu; ++i) {
80103981:	8b 35 04 36 11 80    	mov    0x80113604,%esi
...
8010399d:	0f b6 99 20 36 11 80 	movzbl -0x7feec9e0(%ecx),%ebx
801039a4:	39 c3                	cmp    %eax,%ebx
801039a6:	75 e8                	jne    80103990 <mycpu+0x20>
}
801039a8:	8d 65 f8             	lea    -0x8(%ebp),%esp
      return &cpus[i];
801039ab:	8d 81 20 36 11 80    	lea    -0x7feec9e0(%ecx),%eax
}
801039b1:	5b                   	pop    %ebx
801039b2:	5e                   	pop    %esi
801039b3:	5d                   	pop    %ebp
...
801039db:	c9                   	leave
  return mycpu()-cpus;
801039dc:	2d 20 36 11 80       	sub    $0x80113620,%eax
...
80103a2c:	89 c3                	mov    %eax,%ebx
  initproc = p;
80103a2e:	a3 d4 5a 11 80       	mov    %eax,0x80115ad4
  if((p->pgdir = setupkvm()) == 0)
80103a33:	e8 b8 35 00 00       	call   80106ff0 <setupkvm>
...
80103a51:	e8 7a 32 00 00       	call   80106cd0 <inituvm>
...
80103b03:	68 97 78 10 80       	push   $0x80107897
...
80103b3b:	e8 80 30 00 00       	call   80106bc0 <switchuvm>
  return 0;
...
80103b5a:	e8 c1 32 00 00       	call   80106e20 <allocuvm>
...
80103b7a:	e8 c1 33 00 00       	call   80106f40 <deallocuvm>
...
80103bc8:	e8 13 35 00 00       	call   801070e0 <copyuvm>
...
80103c46:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103c49:	c7 04 24 a0 3b 11 80 	movl   $0x80113ba0,(%esp)
80103c50:	e8 cb 09 00 00       	call   80104620 <acquire>
  np->state = RUNNABLE;
80103c55:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  release(&ptable.lock);
80103c5c:	c7 04 24 a0 3b 11 80 	movl   $0x80113ba0,(%esp)
...
80103cc1:	83 ec 0c             	sub    $0xc,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103cc4:	bb d4 3b 11 80       	mov    $0x80113bd4,%ebx
    acquire(&ptable.lock);
80103cc9:	68 a0 3b 11 80       	push   $0x80113ba0
...
80103cf0:	e8 cb 2e 00 00       	call   80106bc0 <switchuvm>
...
80103d02:	e8 04 0c 00 00       	call   8010490b <swtch>
      switchkvm();
80103d07:	e8 a4 2e 00 00       	call   80106bb0 <switchkvm>
      c->proc = 0;
...
80103d1c:	81 fb d4 5a 11 80    	cmp    $0x80115ad4,%ebx
80103d22:	75 bc                	jne    80103ce0 <scheduler+0x40>
    release(&ptable.lock);
80103d24:	83 ec 0c             	sub    $0xc,%esp
80103d27:	68 a0 3b 11 80       	push   $0x80113ba0
...
80103d5d:	68 a0 3b 11 80       	push   $0x80113ba0
...
80103e09:	e8 e2 fb ff ff       	call   801039f0 <myproc>
  if(curproc == initproc)
80103e0e:	39 05 d4 5a 11 80    	cmp    %eax,0x80115ad4
...
80103e5c:	c7 43 68 00 00 00 00 	movl   $0x0,0x68(%ebx)
  acquire(&ptable.lock);
80103e63:	c7 04 24 a0 3b 11 80 	movl   $0x80113ba0,(%esp)
...
80103e9f:	3d d4 5a 11 80       	cmp    $0x80115ad4,%eax
80103ea4:	75 e4                	jne    80103e8a <exit+0x8a>
      p->parent = initproc;
80103ea6:	8b 0d d4 5a 11 80    	mov    0x80115ad4,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103eac:	ba d4 3b 11 80       	mov    $0x80113bd4,%edx
80103eb1:	eb 10                	jmp    80103ec3 <exit+0xc3>
80103eb3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103eb7:	90                   	nop
80103eb8:	83 c2 7c             	add    $0x7c,%edx
80103ebb:	81 fa d4 5a 11 80    	cmp    $0x80115ad4,%edx
...
80103f0d:	68 08 79 10 80       	push   $0x80107908
80103f12:	e8 69 c4 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103f17:	83 ec 0c             	sub    $0xc,%esp
80103f1a:	68 fb 78 10 80       	push   $0x801078fb
...
80103f81:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f86:	81 fb d4 5a 11 80    	cmp    $0x80115ad4,%ebx
...
80103ff9:	e8 72 2f 00 00       	call   80106f70 <freevm>
        p->pid = 0;
...
80104017:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
8010401e:	c7 04 24 a0 3b 11 80 	movl   $0x80113ba0,(%esp)
...
80104039:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
8010403e:	68 a0 3b 11 80       	push   $0x80113ba0
...
80104050:	68 14 79 10 80       	push   $0x80107914
...
80104067:	68 a0 3b 11 80       	push   $0x80113ba0
...
8010408d:	e8 ae fc ff ff       	call   80103d40 <sched>
  release(&ptable.lock);
80104092:	c7 04 24 a0 3b 11 80 	movl   $0x80113ba0,(%esp)
...
801040e0:	81 fe a0 3b 11 80    	cmp    $0x80113ba0,%esi
801040e6:	74 50                	je     80104138 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
801040e8:	83 ec 0c             	sub    $0xc,%esp
801040eb:	68 a0 3b 11 80       	push   $0x80113ba0
...
8010410c:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
    release(&ptable.lock);
80104113:	c7 04 24 a0 3b 11 80 	movl   $0x80113ba0,(%esp)
...
80104159:	68 1a 79 10 80       	push   $0x8010791a
8010415e:	e8 1d c2 ff ff       	call   80100380 <panic>
    panic("sleep");
80104163:	83 ec 0c             	sub    $0xc,%esp
80104166:	68 14 79 10 80       	push   $0x80107914
...
801041af:	3d d4 5a 11 80       	cmp    $0x80115ad4,%eax
801041b4:	75 e4                	jne    8010419a <wakeup+0x2a>
  wakeup1(chan);
  release(&ptable.lock);
801041b6:	c7 45 08 a0 3b 11 80 	movl   $0x80113ba0,0x8(%ebp)
}
...
80104216:	68 a0 3b 11 80       	push   $0x80113ba0
...
80104233:	68 a0 3b 11 80       	push   $0x80113ba0
...
80104259:	bb 40 3c 11 80       	mov    $0x80113c40,%ebx
...
8010428c:	74 ea                	je     80104278 <procdump+0x28>
      state = "???";
8010428e:	ba 2b 79 10 80       	mov    $0x8010792b,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104293:	83 f8 05             	cmp    $0x5,%eax
80104296:	77 11                	ja     801042a9 <procdump+0x59>
80104298:	8b 14 85 8c 79 10 80 	mov    -0x7fef8674(,%eax,4),%edx
      state = "???";
8010429f:	b8 2b 79 10 80       	mov    $0x8010792b,%eax
...
801042ae:	68 2f 79 10 80       	push   $0x8010792f
...
801042ed:	68 81 73 10 80       	push   $0x80107381
...
8010431a:	68 a4 79 10 80       	push   $0x801079a4
...
80104565:	68 af 79 10 80       	push   $0x801079af
8010456a:	e8 11 be ff ff       	call   80100380 <panic>
    panic("popcli");
8010456f:	83 ec 0c             	sub    $0xc,%esp
80104572:	68 c6 79 10 80       	push   $0x801079c6
...
801045db:	68 cd 79 10 80       	push   $0x801079cd
...
801046f0:	68 d5 79 10 80       	push   $0x801079d5
...
80104acc:	29 d8                	sub    %ebx,%eax
  int addr;
  if(argint(n, &addr) < 0)  //the argument is pointer to char
    return -1;
...
80104b0c:	8b 14 85 00 7a 10 80 	mov    -0x7fef8600(,%eax,4),%edx
...
80104b38:	68 dd 79 10 80       	push   $0x801079dd
...
80104c84:	68 78 7a 10 80       	push   $0x80107a78
...
80104c9c:	68 77 7a 10 80       	push   $0x80107a77
...
801050bd:	58                   	pop    %eax
801050be:	5a                   	pop    %edx
801050bf:	68 78 7a 10 80       	push   $0x80107a78
...
801050d8:	68 77 7a 10 80       	push   $0x80107a77
...
80105259:	0f 88 96 01 00 00    	js     801053f5 <sys_open+0x1b5>
...
80105272:	0f 88 7d 01 00 00    	js     801053f5 <sys_open+0x1b5>
    return -1;

  begin_op();
80105278:	e8 53 db ff ff       	call   80102dd0 <begin_op>

  if(omode & O_CREATE){
8010527d:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
80105280:	81 e3 00 02 00 00    	and    $0x200,%ebx
80105286:	0f 85 8c 00 00 00    	jne    80105318 <sys_open+0xd8>
    if(ip == 0){
      end_op();
      return -1;
    }
...
8010528f:	ff 75 e0             	push   -0x20(%ebp)
80105292:	e8 69 ce ff ff       	call   80102100 <namei>
80105297:	83 c4 10             	add    $0x10,%esp
8010529a:	89 c6                	mov    %eax,%esi
8010529c:	85 c0                	test   %eax,%eax
8010529e:	0f 84 91 00 00 00    	je     80105335 <sys_open+0xf5>
      end_op();
      return -1;
    }
    ilock(ip);
...
801052a8:	e8 23 c5 ff ff       	call   801017d0 <ilock>

    if( ip->type == T_SYMLINK && omode != O_NOFOLLOW){
801052ad:	0f b7 46 50          	movzwl 0x50(%esi),%eax
801052b1:	83 c4 10             	add    $0x10,%esp
801052b4:	66 83 f8 04          	cmp    $0x4,%ax
801052b8:	0f 84 ca 00 00 00    	je     80105388 <sys_open+0x148>
...
801052be:	66 83 f8 01          	cmp    $0x1,%ax
801052c2:	0f 84 38 01 00 00    	je     80105400 <sys_open+0x1c0>
      end_op();
      return -1;
    }
  }
...
801052c8:	e8 b3 bb ff ff       	call   80100e80 <filealloc>
801052cd:	89 c7                	mov    %eax,%edi
801052cf:	85 c0                	test   %eax,%eax
801052d1:	74 29                	je     801052fc <sys_open+0xbc>
  struct proc *curproc = myproc();
801052d3:	e8 18 e7 ff ff       	call   801039f0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801052e6:	74 58                	je     80105340 <sys_open+0x100>
  for(fd = 0; fd < NOFILE; fd++){
801052e8:	83 c3 01             	add    $0x1,%ebx
801052eb:	83 fb 10             	cmp    $0x10,%ebx
801052ee:	75 f0                	jne    801052e0 <sys_open+0xa0>
    if(f)
      fileclose(f);
...
8010530d:	e9 e3 00 00 00       	jmp    801053f5 <sys_open+0x1b5>
...
80105327:	e8 34 f8 ff ff       	call   80104b60 <create>
    if(ip == 0){
...
80105333:	75 93                	jne    801052c8 <sys_open+0x88>
      end_op();
80105335:	e8 06 db ff ff       	call   80102e40 <end_op>
      return -1;
8010533a:	e9 b6 00 00 00       	jmp    801053f5 <sys_open+0x1b5>
8010533f:	90                   	nop
  }
  iunlock(ip);
...
80105348:	e8 63 c5 ff ff       	call   801018b0 <iunlock>
  end_op();
8010534d:	e8 ee da ff ff       	call   80102e40 <end_op>
...
80105387:	90                   	nop
    if( ip->type == T_SYMLINK && omode != O_NOFOLLOW){
80105388:	81 7d e4 00 01 00 00 	cmpl   $0x100,-0x1c(%ebp)
8010538f:	75 39                	jne    801053ca <sys_open+0x18a>
80105391:	e9 32 ff ff ff       	jmp    801052c8 <sys_open+0x88>
...
801053a7:	e8 b4 c6 ff ff       	call   80101a60 <iunlockput>
        ilock(ip_next) ;
801053ac:	89 34 24             	mov    %esi,(%esp)
801053af:	e8 1c c4 ff ff       	call   801017d0 <ilock>
      while(ip->type == T_SYMLINK && count < 12 ){
801053b4:	0f b7 46 50          	movzwl 0x50(%esi),%eax
801053b8:	83 c4 10             	add    $0x10,%esp
801053bb:	66 83 f8 04          	cmp    $0x4,%ax
801053bf:	75 4f                	jne    80105410 <sys_open+0x1d0>
801053c1:	83 fb 0c             	cmp    $0xc,%ebx
801053c4:	0f 84 32 ff ff ff    	je     801052fc <sys_open+0xbc>
        ip_next = namei( ip->symlink_name);
801053ca:	83 ec 0c             	sub    $0xc,%esp
801053cd:	8d 86 90 00 00 00    	lea    0x90(%esi),%eax
801053d3:	89 f7                	mov    %esi,%edi
801053d5:	50                   	push   %eax
801053d6:	e8 25 cd ff ff       	call   80102100 <namei>
        if(ip_next == 0){
...
801053e2:	75 bc                	jne    801053a0 <sys_open+0x160>
          iunlockput(ip);
801053e4:	83 ec 0c             	sub    $0xc,%esp
801053e7:	57                   	push   %edi
801053e8:	e8 73 c6 ff ff       	call   80101a60 <iunlockput>
          end_op();
801053ed:	e8 4e da ff ff       	call   80102e40 <end_op>
          return -1;
801053f2:	83 c4 10             	add    $0x10,%esp
    return -1;
801053f5:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
801053fa:	e9 7a ff ff ff       	jmp    80105379 <sys_open+0x139>
801053ff:	90                   	nop
    if(ip->type == T_DIR && omode != O_RDONLY){
80105400:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80105403:	85 c9                	test   %ecx,%ecx
80105405:	0f 84 bd fe ff ff    	je     801052c8 <sys_open+0x88>
8010540b:	e9 ec fe ff ff       	jmp    801052fc <sys_open+0xbc>
      if(count == 12 ){
80105410:	83 fb 0c             	cmp    $0xc,%ebx
80105413:	0f 85 a5 fe ff ff    	jne    801052be <sys_open+0x7e>
80105419:	e9 de fe ff ff       	jmp    801052fc <sys_open+0xbc>
...
80105423:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
80105426:	e8 a5 d9 ff ff       	call   80102dd0 <begin_op>
...
8010544f:	e8 0c f7 ff ff       	call   80104b60 <create>
...
8010545f:	e8 fc c5 ff ff       	call   80101a60 <iunlockput>
  end_op();
80105464:	e8 d7 d9 ff ff       	call   80102e40 <end_op>
  return 0;
...
80105483:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
80105486:	e8 45 d9 ff ff       	call   80102dd0 <begin_op>
  if((argstr(0, &path)) < 0 ||
...
801054ee:	e8 6d c5 ff ff       	call   80101a60 <iunlockput>
  end_op();
801054f3:	e8 48 d9 ff ff       	call   80102e40 <end_op>
  return 0;
...
801054ff:	90                   	nop
    end_op();
80105500:	e8 3b d9 ff ff       	call   80102e40 <end_op>
    return -1;
...
80105515:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105518:	e8 d3 e4 ff ff       	call   801039f0 <myproc>
8010551d:	89 c6                	mov    %eax,%esi
  
  begin_op();
8010551f:	e8 ac d8 ff ff       	call   80102dd0 <begin_op>
...
8010553f:	e8 bc cb ff ff       	call   80102100 <namei>
...
80105551:	e8 7a c2 ff ff       	call   801017d0 <ilock>
  if(ip->type != T_DIR){
...
80105564:	e8 47 c3 ff ff       	call   801018b0 <iunlock>
  iput(curproc->cwd);
80105569:	58                   	pop    %eax
8010556a:	ff 76 68             	push   0x68(%esi)
8010556d:	e8 8e c3 ff ff       	call   80101900 <iput>
  end_op();
80105572:	e8 c9 d8 ff ff       	call   80102e40 <end_op>
  curproc->cwd = ip;
...
80105594:	e8 c7 c4 ff ff       	call   80101a60 <iunlockput>
    end_op();
80105599:	e8 a2 d8 ff ff       	call   80102e40 <end_op>
    return -1;
...
801055af:	90                   	nop
    end_op();
801055b0:	e8 8b d8 ff ff       	call   80102e40 <end_op>
    return -1;
...
801056dc:	e8 bf dd ff ff       	call   801034a0 <pipealloc>
...
801056eb:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
801056ed:	e8 fe e2 ff ff       	call   801039f0 <myproc>
    if(curproc->ofile[fd] == 0){
...
80105717:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
8010571a:	e8 d1 e2 ff ff       	call   801039f0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105736:	75 f0                	jne    80105728 <sys_pipe+0x78>
    if(fd0 >= 0)
      myproc()->ofile[fd0] = 0;
80105738:	e8 b3 e2 ff ff       	call   801039f0 <myproc>
...
8010579d:	e8 ce f2 ff ff       	call   80104a70 <argstr>
801057a2:	83 c4 10             	add    $0x10,%esp
801057a5:	85 c0                	test   %eax,%eax
801057a7:	0f 88 8b 00 00 00    	js     80105838 <sys_symlink+0xa8>
801057ad:	83 ec 08             	sub    $0x8,%esp
801057b0:	8d 45 f4             	lea    -0xc(%ebp),%eax
801057b3:	50                   	push   %eax
801057b4:	6a 01                	push   $0x1
801057b6:	e8 b5 f2 ff ff       	call   80104a70 <argstr>
801057bb:	83 c4 10             	add    $0x10,%esp
801057be:	85 c0                	test   %eax,%eax
801057c0:	78 76                	js     80105838 <sys_symlink+0xa8>
    return -1;
  }

  begin_op();
801057c2:	e8 09 d6 ff ff       	call   80102dd0 <begin_op>

  struct inode* ip = create(path,T_SYMLINK,0,0);
801057c7:	83 ec 0c             	sub    $0xc,%esp
801057ca:	8b 45 f4             	mov    -0xc(%ebp),%eax
801057cd:	31 c9                	xor    %ecx,%ecx
801057cf:	6a 00                	push   $0x0
801057d1:	ba 04 00 00 00       	mov    $0x4,%edx
801057d6:	e8 85 f3 ff ff       	call   80104b60 <create>

  if(ip == 0){
801057db:	83 c4 10             	add    $0x10,%esp
  struct inode* ip = create(path,T_SYMLINK,0,0);
801057de:	89 c3                	mov    %eax,%ebx
  if(ip == 0){
801057e0:	85 c0                	test   %eax,%eax
801057e2:	74 4a                	je     8010582e <sys_symlink+0x9e>
    end_op();
    return -1;
  }
...
801057ea:	e8 01 f1 ff ff       	call   801048f0 <strlen>

  if( len > MAXFILE_NAME){
801057ef:	83 c4 10             	add    $0x10,%esp
801057f2:	3d 9b 00 00 00       	cmp    $0x9b,%eax
801057f7:	7f 46                	jg     8010583f <sys_symlink+0xaf>
...
80105800:	8d 83 90 00 00 00    	lea    0x90(%ebx),%eax
80105806:	ff 75 f0             	push   -0x10(%ebp)
80105809:	50                   	push   %eax
8010580a:	e8 41 f0 ff ff       	call   80104850 <strncpy>


  iupdate(ip);
8010580f:	89 1c 24             	mov    %ebx,(%esp)
80105812:	e8 09 bf ff ff       	call   80101720 <iupdate>
  iunlockput(ip);
80105817:	89 1c 24             	mov    %ebx,(%esp)
8010581a:	e8 41 c2 ff ff       	call   80101a60 <iunlockput>

  end_op();
8010581f:	e8 1c d6 ff ff       	call   80102e40 <end_op>
...
80105829:	8b 5d fc             	mov    -0x4(%ebp),%ebx
8010582c:	c9                   	leave
8010582d:	c3                   	ret
    end_op();
8010582e:	e8 0d d6 ff ff       	call   80102e40 <end_op>
    return -1;
80105833:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80105837:	90                   	nop
    return -1;
80105838:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010583d:	eb ea                	jmp    80105829 <sys_symlink+0x99>
    panic("large symlink file_name ");
8010583f:	83 ec 0c             	sub    $0xc,%esp
80105842:	68 bd 7a 10 80       	push   $0x80107abd
80105847:	e8 34 ab ff ff       	call   80100380 <panic>
...
{
  return fork();
80105850:	e9 3b e3 ff ff       	jmp    80103b90 <fork>
...
80105863:	83 ec 08             	sub    $0x8,%esp
  exit();
80105866:	e8 95 e5 ff ff       	call   80103e00 <exit>
...
{
  return wait();
80105870:	e9 bb e6 ff ff       	jmp    80103f30 <wait>
...
8010588c:	e8 1f f1 ff ff       	call   801049b0 <argint>
...
8010589e:	e8 2d e9 ff ff       	call   801041d0 <kill>
...
801058c3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801058c6:	e8 25 e1 ff ff       	call   801039f0 <myproc>
...
801058f6:	e8 15 e2 ff ff       	call   80103b10 <growproc>
...
8010592d:	e8 7e f0 ff ff       	call   801049b0 <argint>
...
8010593c:	68 00 5b 11 80       	push   $0x80115b00
80105941:	e8 da ec ff ff       	call   80104620 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105946:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
80105949:	8b 1d e0 5a 11 80    	mov    0x80115ae0,%ebx
  while(ticks - ticks0 < n){
...
80105963:	68 00 5b 11 80       	push   $0x80115b00
80105968:	68 e0 5a 11 80       	push   $0x80115ae0
8010596d:	e8 3e e7 ff ff       	call   801040b0 <sleep>
  while(ticks - ticks0 < n){
80105972:	a1 e0 5a 11 80       	mov    0x80115ae0,%eax
...
8010597f:	73 2f                	jae    801059b0 <sys_sleep+0x90>
    if(myproc()->killed){
80105981:	e8 6a e0 ff ff       	call   801039f0 <myproc>
...
80105990:	68 00 5b 11 80       	push   $0x80115b00
80105995:	e8 26 ec ff ff       	call   801045c0 <release>
      return -1;
...
801059b3:	68 00 5b 11 80       	push   $0x80115b00
801059b8:	e8 03 ec ff ff       	call   801045c0 <release>
}
...
801059d4:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
801059d7:	68 00 5b 11 80       	push   $0x80115b00
801059dc:	e8 3f ec ff ff       	call   80104620 <acquire>
  xticks = ticks;
801059e1:	8b 1d e0 5a 11 80    	mov    0x80115ae0,%ebx
  release(&tickslock);
801059e7:	c7 04 24 00 5b 11 80 	movl   $0x80115b00,(%esp)
801059ee:	e8 cd eb ff ff       	call   801045c0 <release>
  return xticks;
}
...
80105a37:	c7 04 c5 42 5b 11 80 	movl   $0x8e000008,-0x7feea4be(,%eax,8)
80105a3e:	08 00 00 8e 
80105a42:	66 89 14 c5 40 5b 11 	mov    %dx,-0x7feea4c0(,%eax,8)
80105a49:	80 
80105a4a:	c1 ea 10             	shr    $0x10,%edx
80105a4d:	66 89 14 c5 46 5b 11 	mov    %dx,-0x7feea4ba(,%eax,8)
80105a54:	80 
  for(i = 0; i < 256; i++)
...
80105a67:	c7 05 42 5d 11 80 08 	movl   $0xef000008,0x80115d42
80105a6e:	00 00 ef 
  initlock(&tickslock, "time");
80105a71:	68 d6 7a 10 80       	push   $0x80107ad6
80105a76:	68 00 5b 11 80       	push   $0x80115b00
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105a7b:	66 a3 40 5d 11 80    	mov    %ax,0x80115d40
80105a81:	c1 e8 10             	shr    $0x10,%eax
80105a84:	66 a3 46 5d 11 80    	mov    %ax,0x80115d46
  initlock(&tickslock, "time");
80105a8a:	e8 b1 e9 ff ff       	call   80104440 <initlock>
}
...
80105aab:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105aaf:	b8 40 5b 11 80       	mov    $0x80115b40,%eax
...
80105af4:	ff 24 85 7c 7b 10 80 	jmp    *-0x7fef8484(,%eax,4)
...
80105aff:	90                   	nop
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80105b00:	e8 ab c7 ff ff       	call   801022b0 <ideintr>
    lapiceoi();
...
80105b0a:	e8 e1 de ff ff       	call   801039f0 <myproc>
80105b0f:	85 c0                	test   %eax,%eax
80105b11:	74 1d                	je     80105b30 <trap+0x60>
80105b13:	e8 d8 de ff ff       	call   801039f0 <myproc>
...
80105b30:	e8 bb de ff ff       	call   801039f0 <myproc>
80105b35:	85 c0                	test   %eax,%eax
80105b37:	74 0f                	je     80105b48 <trap+0x78>
80105b39:	e8 b2 de ff ff       	call   801039f0 <myproc>
...
80105b80:	e8 6b de ff ff       	call   801039f0 <myproc>
...
80105ba0:	e8 2b de ff ff       	call   801039d0 <cpuid>
...
80105bb1:	e8 3a de ff ff       	call   801039f0 <myproc>
80105bb6:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105bb9:	e8 32 de ff ff       	call   801039f0 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105bbe:	8b 4d d8             	mov    -0x28(%ebp),%ecx
80105bc1:	51                   	push   %ecx
80105bc2:	57                   	push   %edi
80105bc3:	8b 55 dc             	mov    -0x24(%ebp),%edx
...
80105bd5:	68 38 7b 10 80       	push   $0x80107b38
80105bda:	e8 d1 aa ff ff       	call   801006b0 <cprintf>
    myproc()->killed = 1;
80105bdf:	83 c4 20             	add    $0x20,%esp
80105be2:	e8 09 de ff ff       	call   801039f0 <myproc>
80105be7:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105bee:	e8 fd dd ff ff       	call   801039f0 <myproc>
...
80105c04:	0f 85 3e ff ff ff    	jne    80105b48 <trap+0x78>
    yield();
80105c0a:	e8 51 e4 ff ff       	call   80104060 <yield>
...
80105c1f:	e8 ac dd ff ff       	call   801039d0 <cpuid>
80105c24:	57                   	push   %edi
80105c25:	56                   	push   %esi
80105c26:	50                   	push   %eax
80105c27:	68 e0 7a 10 80       	push   $0x80107ae0
80105c2c:	e8 7f aa ff ff       	call   801006b0 <cprintf>
    lapiceoi();
80105c31:	e8 4a cd ff ff       	call   80102980 <lapiceoi>
    break;
80105c36:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c39:	e8 b2 dd ff ff       	call   801039f0 <myproc>
...
80105c4f:	90                   	nop
    if(myproc()->killed)
80105c50:	e8 9b dd ff ff       	call   801039f0 <myproc>
80105c55:	8b 70 24             	mov    0x24(%eax),%esi
80105c58:	85 f6                	test   %esi,%esi
80105c5a:	0f 85 c8 00 00 00    	jne    80105d28 <trap+0x258>
    myproc()->tf = tf;
80105c60:	e8 8b dd ff ff       	call   801039f0 <myproc>
80105c65:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105c68:	e8 83 ee ff ff       	call   80104af0 <syscall>
    if(myproc()->killed)
80105c6d:	e8 7e dd ff ff       	call   801039f0 <myproc>
...
80105c83:	5d                   	pop    %ebp
      exit();
80105c84:	e9 77 e1 ff ff       	jmp    80103e00 <exit>
80105c89:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    uartintr();
80105c90:	e8 4b 02 00 00       	call   80105ee0 <uartintr>
    lapiceoi();
80105c95:	e8 e6 cc ff ff       	call   80102980 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c9a:	e8 51 dd ff ff       	call   801039f0 <myproc>
...
80105cac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
80105cb0:	e8 8b cb ff ff       	call   80102840 <kbdintr>
    lapiceoi();
80105cb5:	e8 c6 cc ff ff       	call   80102980 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105cba:	e8 31 dd ff ff       	call   801039f0 <myproc>
...
80105ccc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
80105cd0:	e8 fb dc ff ff       	call   801039d0 <cpuid>
80105cd5:	85 c0                	test   %eax,%eax
80105cd7:	0f 85 28 fe ff ff    	jne    80105b05 <trap+0x35>
      acquire(&tickslock);
80105cdd:	83 ec 0c             	sub    $0xc,%esp
80105ce0:	68 00 5b 11 80       	push   $0x80115b00
80105ce5:	e8 36 e9 ff ff       	call   80104620 <acquire>
      ticks++;
80105cea:	83 05 e0 5a 11 80 01 	addl   $0x1,0x80115ae0
      wakeup(&ticks);
80105cf1:	c7 04 24 e0 5a 11 80 	movl   $0x80115ae0,(%esp)
80105cf8:	e8 73 e4 ff ff       	call   80104170 <wakeup>
      release(&tickslock);
80105cfd:	c7 04 24 00 5b 11 80 	movl   $0x80115b00,(%esp)
80105d04:	e8 b7 e8 ff ff       	call   801045c0 <release>
...
{
  if(!uart)
80105d60:	a1 40 63 11 80       	mov    0x80116340,%eax
...
80105de7:	0f 84 7c 00 00 00    	je     80105e69 <uartinit+0xd9>
  uart = 1;
80105ded:	c7 05 40 63 11 80 01 	movl   $0x1,0x80116340
80105df4:	00 00 00 
80105df7:	89 fa                	mov    %edi,%edx
80105df9:	ec                   	in     (%dx),%al
80105dfa:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105dff:	ec                   	in     (%dx),%al
  ioapicenable(IRQ_COM1, 0);
80105e00:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105e03:	bf fc 7b 10 80       	mov    $0x80107bfc,%edi
80105e08:	be fd 03 00 00       	mov    $0x3fd,%esi
  ioapicenable(IRQ_COM1, 0);
80105e0d:	6a 00                	push   $0x0
80105e0f:	6a 04                	push   $0x4
80105e11:	e8 ca c6 ff ff       	call   801024e0 <ioapicenable>
  for(p="xv6...\n"; *p; p++)
80105e16:	c6 45 e7 78          	movb   $0x78,-0x19(%ebp)
  ioapicenable(IRQ_COM1, 0);
80105e1a:	83 c4 10             	add    $0x10,%esp
80105e1d:	8d 76 00             	lea    0x0(%esi),%esi
  if(!uart)
80105e20:	a1 40 63 11 80       	mov    0x80116340,%eax
80105e25:	85 c0                	test   %eax,%eax
80105e27:	74 32                	je     80105e5b <uartinit+0xcb>
80105e29:	89 f2                	mov    %esi,%edx
80105e2b:	ec                   	in     (%dx),%al
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80105e2c:	a8 20                	test   $0x20,%al
80105e2e:	75 21                	jne    80105e51 <uartinit+0xc1>
80105e30:	bb 80 00 00 00       	mov    $0x80,%ebx
80105e35:	8d 76 00             	lea    0x0(%esi),%esi
    microdelay(10);
80105e38:	83 ec 0c             	sub    $0xc,%esp
80105e3b:	6a 0a                	push   $0xa
80105e3d:	e8 5e cb ff ff       	call   801029a0 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80105e42:	83 c4 10             	add    $0x10,%esp
80105e45:	83 eb 01             	sub    $0x1,%ebx
80105e48:	74 07                	je     80105e51 <uartinit+0xc1>
80105e4a:	89 f2                	mov    %esi,%edx
80105e4c:	ec                   	in     (%dx),%al
80105e4d:	a8 20                	test   $0x20,%al
80105e4f:	74 e7                	je     80105e38 <uartinit+0xa8>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80105e51:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105e56:	0f b6 45 e7          	movzbl -0x19(%ebp),%eax
80105e5a:	ee                   	out    %al,(%dx)
  for(p="xv6...\n"; *p; p++)
80105e5b:	0f b6 47 01          	movzbl 0x1(%edi),%eax
80105e5f:	83 c7 01             	add    $0x1,%edi
80105e62:	88 45 e7             	mov    %al,-0x19(%ebp)
80105e65:	84 c0                	test   %al,%al
80105e67:	75 b7                	jne    80105e20 <uartinit+0x90>
}
...
80105e80 <uartputc>:
  if(!uart)
80105e80:	a1 40 63 11 80       	mov    0x80116340,%eax
80105e85:	85 c0                	test   %eax,%eax
80105e87:	74 4f                	je     80105ed8 <uartputc+0x58>
{
80105e89:	55                   	push   %ebp
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80105e8a:	ba fd 03 00 00       	mov    $0x3fd,%edx
80105e8f:	89 e5                	mov    %esp,%ebp
80105e91:	56                   	push   %esi
80105e92:	53                   	push   %ebx
80105e93:	ec                   	in     (%dx),%al
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80105e94:	a8 20                	test   $0x20,%al
80105e96:	75 29                	jne    80105ec1 <uartputc+0x41>
...
80105eab:	6a 0a                	push   $0xa
80105ead:	e8 ee ca ff ff       	call   801029a0 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80105eb2:	83 c4 10             	add    $0x10,%esp
80105eb5:	83 eb 01             	sub    $0x1,%ebx
80105eb8:	74 07                	je     80105ec1 <uartputc+0x41>
80105eba:	89 f2                	mov    %esi,%edx
80105ebc:	ec                   	in     (%dx),%al
80105ebd:	a8 20                	test   $0x20,%al
80105ebf:	74 e7                	je     80105ea8 <uartputc+0x28>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80105ec1:	8b 45 08             	mov    0x8(%ebp),%eax
80105ec4:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105ec9:	ee                   	out    %al,(%dx)
}
80105eca:	8d 65 f8             	lea    -0x8(%ebp),%esp
80105ecd:	5b                   	pop    %ebx
80105ece:	5e                   	pop    %esi
80105ecf:	5d                   	pop    %ebp
80105ed0:	c3                   	ret
...
80105ee6:	68 60 5d 10 80       	push   $0x80105d60
80105eeb:	e8 d0 a9 ff ff       	call   801008c0 <consoleintr>
}
...
80105ef7:	6a 00                	push   $0x0
  jmp alltraps
80105ef9:	e9 fc fa ff ff       	jmp    801059fa <alltraps>
...
80105f00:	6a 01                	push   $0x1
  jmp alltraps
80105f02:	e9 f3 fa ff ff       	jmp    801059fa <alltraps>
...
80105f09:	6a 02                	push   $0x2
  jmp alltraps
80105f0b:	e9 ea fa ff ff       	jmp    801059fa <alltraps>
...
80105f12:	6a 03                	push   $0x3
  jmp alltraps
80105f14:	e9 e1 fa ff ff       	jmp    801059fa <alltraps>
...
80105f24:	6a 05                	push   $0x5
  jmp alltraps
80105f26:	e9 cf fa ff ff       	jmp    801059fa <alltraps>
...
80105f36:	6a 07                	push   $0x7
  jmp alltraps
80105f38:	e9 bd fa ff ff       	jmp    801059fa <alltraps>
...
80105f3d:	6a 08                	push   $0x8
  jmp alltraps
80105f3f:	e9 b6 fa ff ff       	jmp    801059fa <alltraps>
...
80105f46:	6a 09                	push   $0x9
  jmp alltraps
80105f48:	e9 ad fa ff ff       	jmp    801059fa <alltraps>
...
80105f4d:	6a 0a                	push   $0xa
  jmp alltraps
80105f4f:	e9 a6 fa ff ff       	jmp    801059fa <alltraps>
...
80105f69:	6a 0e                	push   $0xe
  jmp alltraps
80105f6b:	e9 8a fa ff ff       	jmp    801059fa <alltraps>
...
80105f72:	6a 0f                	push   $0xf
  jmp alltraps
80105f74:	e9 81 fa ff ff       	jmp    801059fa <alltraps>
...
80105f7b:	6a 10                	push   $0x10
  jmp alltraps
80105f7d:	e9 78 fa ff ff       	jmp    801059fa <alltraps>
...
80105f82:	6a 11                	push   $0x11
  jmp alltraps
80105f84:	e9 71 fa ff ff       	jmp    801059fa <alltraps>
...
80105f8b:	6a 12                	push   $0x12
  jmp alltraps
80105f8d:	e9 68 fa ff ff       	jmp    801059fa <alltraps>
...
80105f94:	6a 13                	push   $0x13
  jmp alltraps
80105f96:	e9 5f fa ff ff       	jmp    801059fa <alltraps>
...
80105f9d:	6a 14                	push   $0x14
  jmp alltraps
80105f9f:	e9 56 fa ff ff       	jmp    801059fa <alltraps>
...
80105fa6:	6a 15                	push   $0x15
  jmp alltraps
80105fa8:	e9 4d fa ff ff       	jmp    801059fa <alltraps>
...
80105faf:	6a 16                	push   $0x16
  jmp alltraps
80105fb1:	e9 44 fa ff ff       	jmp    801059fa <alltraps>
...
80105fb8:	6a 17                	push   $0x17
  jmp alltraps
80105fba:	e9 3b fa ff ff       	jmp    801059fa <alltraps>
...
80105fc1:	6a 18                	push   $0x18
  jmp alltraps
80105fc3:	e9 32 fa ff ff       	jmp    801059fa <alltraps>
...
80105fca:	6a 19                	push   $0x19
  jmp alltraps
80105fcc:	e9 29 fa ff ff       	jmp    801059fa <alltraps>
...
80105fd3:	6a 1a                	push   $0x1a
  jmp alltraps
80105fd5:	e9 20 fa ff ff       	jmp    801059fa <alltraps>
...
80105fdc:	6a 1b                	push   $0x1b
  jmp alltraps
80105fde:	e9 17 fa ff ff       	jmp    801059fa <alltraps>
...
80105fe5:	6a 1c                	push   $0x1c
  jmp alltraps
80105fe7:	e9 0e fa ff ff       	jmp    801059fa <alltraps>
...
80105fee:	6a 1d                	push   $0x1d
  jmp alltraps
80105ff0:	e9 05 fa ff ff       	jmp    801059fa <alltraps>
...
80105ff7:	6a 1e                	push   $0x1e
  jmp alltraps
80105ff9:	e9 fc f9 ff ff       	jmp    801059fa <alltraps>
...
80106000:	6a 1f                	push   $0x1f
  jmp alltraps
80106002:	e9 f3 f9 ff ff       	jmp    801059fa <alltraps>
...
80106009:	6a 20                	push   $0x20
  jmp alltraps
8010600b:	e9 ea f9 ff ff       	jmp    801059fa <alltraps>
...
80106012:	6a 21                	push   $0x21
  jmp alltraps
80106014:	e9 e1 f9 ff ff       	jmp    801059fa <alltraps>
...
8010601b:	6a 22                	push   $0x22
  jmp alltraps
8010601d:	e9 d8 f9 ff ff       	jmp    801059fa <alltraps>
...
80106024:	6a 23                	push   $0x23
  jmp alltraps
80106026:	e9 cf f9 ff ff       	jmp    801059fa <alltraps>
...
8010602d:	6a 24                	push   $0x24
  jmp alltraps
8010602f:	e9 c6 f9 ff ff       	jmp    801059fa <alltraps>
...
80106036:	6a 25                	push   $0x25
  jmp alltraps
80106038:	e9 bd f9 ff ff       	jmp    801059fa <alltraps>
...
8010603f:	6a 26                	push   $0x26
  jmp alltraps
80106041:	e9 b4 f9 ff ff       	jmp    801059fa <alltraps>
...
80106048:	6a 27                	push   $0x27
  jmp alltraps
8010604a:	e9 ab f9 ff ff       	jmp    801059fa <alltraps>
...
80106051:	6a 28                	push   $0x28
  jmp alltraps
80106053:	e9 a2 f9 ff ff       	jmp    801059fa <alltraps>
...
8010605a:	6a 29                	push   $0x29
  jmp alltraps
8010605c:	e9 99 f9 ff ff       	jmp    801059fa <alltraps>
...
80106063:	6a 2a                	push   $0x2a
  jmp alltraps
80106065:	e9 90 f9 ff ff       	jmp    801059fa <alltraps>
...
8010606c:	6a 2b                	push   $0x2b
  jmp alltraps
8010606e:	e9 87 f9 ff ff       	jmp    801059fa <alltraps>
...
80106075:	6a 2c                	push   $0x2c
  jmp alltraps
80106077:	e9 7e f9 ff ff       	jmp    801059fa <alltraps>
...
8010607e:	6a 2d                	push   $0x2d
  jmp alltraps
80106080:	e9 75 f9 ff ff       	jmp    801059fa <alltraps>
...
80106087:	6a 2e                	push   $0x2e
  jmp alltraps
80106089:	e9 6c f9 ff ff       	jmp    801059fa <alltraps>
...
80106090:	6a 2f                	push   $0x2f
  jmp alltraps
80106092:	e9 63 f9 ff ff       	jmp    801059fa <alltraps>
...
80106099:	6a 30                	push   $0x30
  jmp alltraps
8010609b:	e9 5a f9 ff ff       	jmp    801059fa <alltraps>
...
801060a2:	6a 31                	push   $0x31
  jmp alltraps
801060a4:	e9 51 f9 ff ff       	jmp    801059fa <alltraps>
...
801060ab:	6a 32                	push   $0x32
  jmp alltraps
801060ad:	e9 48 f9 ff ff       	jmp    801059fa <alltraps>
...
801060b4:	6a 33                	push   $0x33
  jmp alltraps
801060b6:	e9 3f f9 ff ff       	jmp    801059fa <alltraps>
...
801060bd:	6a 34                	push   $0x34
  jmp alltraps
801060bf:	e9 36 f9 ff ff       	jmp    801059fa <alltraps>
...
801060c6:	6a 35                	push   $0x35
  jmp alltraps
801060c8:	e9 2d f9 ff ff       	jmp    801059fa <alltraps>
...
801060cf:	6a 36                	push   $0x36
  jmp alltraps
801060d1:	e9 24 f9 ff ff       	jmp    801059fa <alltraps>
...
801060d8:	6a 37                	push   $0x37
  jmp alltraps
801060da:	e9 1b f9 ff ff       	jmp    801059fa <alltraps>
...
801060e1:	6a 38                	push   $0x38
  jmp alltraps
801060e3:	e9 12 f9 ff ff       	jmp    801059fa <alltraps>
...
801060ea:	6a 39                	push   $0x39
  jmp alltraps
801060ec:	e9 09 f9 ff ff       	jmp    801059fa <alltraps>
...
801060f3:	6a 3a                	push   $0x3a
  jmp alltraps
801060f5:	e9 00 f9 ff ff       	jmp    801059fa <alltraps>
...
801060fc:	6a 3b                	push   $0x3b
  jmp alltraps
801060fe:	e9 f7 f8 ff ff       	jmp    801059fa <alltraps>
...
80106105:	6a 3c                	push   $0x3c
  jmp alltraps
80106107:	e9 ee f8 ff ff       	jmp    801059fa <alltraps>
...
8010610e:	6a 3d                	push   $0x3d
  jmp alltraps
80106110:	e9 e5 f8 ff ff       	jmp    801059fa <alltraps>
...
80106117:	6a 3e                	push   $0x3e
  jmp alltraps
80106119:	e9 dc f8 ff ff       	jmp    801059fa <alltraps>
...
80106120:	6a 3f                	push   $0x3f
  jmp alltraps
80106122:	e9 d3 f8 ff ff       	jmp    801059fa <alltraps>
...
80106129:	6a 40                	push   $0x40
  jmp alltraps
8010612b:	e9 ca f8 ff ff       	jmp    801059fa <alltraps>
...
80106132:	6a 41                	push   $0x41
  jmp alltraps
80106134:	e9 c1 f8 ff ff       	jmp    801059fa <alltraps>
...
8010613b:	6a 42                	push   $0x42
  jmp alltraps
8010613d:	e9 b8 f8 ff ff       	jmp    801059fa <alltraps>
...
80106144:	6a 43                	push   $0x43
  jmp alltraps
80106146:	e9 af f8 ff ff       	jmp    801059fa <alltraps>
...
8010614d:	6a 44                	push   $0x44
  jmp alltraps
8010614f:	e9 a6 f8 ff ff       	jmp    801059fa <alltraps>
...
80106156:	6a 45                	push   $0x45
  jmp alltraps
80106158:	e9 9d f8 ff ff       	jmp    801059fa <alltraps>
...
8010615f:	6a 46                	push   $0x46
  jmp alltraps
80106161:	e9 94 f8 ff ff       	jmp    801059fa <alltraps>
...
80106168:	6a 47                	push   $0x47
  jmp alltraps
8010616a:	e9 8b f8 ff ff       	jmp    801059fa <alltraps>
...
80106171:	6a 48                	push   $0x48
  jmp alltraps
80106173:	e9 82 f8 ff ff       	jmp    801059fa <alltraps>
...
8010617a:	6a 49                	push   $0x49
  jmp alltraps
8010617c:	e9 79 f8 ff ff       	jmp    801059fa <alltraps>
...
80106183:	6a 4a                	push   $0x4a
  jmp alltraps
80106185:	e9 70 f8 ff ff       	jmp    801059fa <alltraps>
...
8010618c:	6a 4b                	push   $0x4b
  jmp alltraps
8010618e:	e9 67 f8 ff ff       	jmp    801059fa <alltraps>
...
80106195:	6a 4c                	push   $0x4c
  jmp alltraps
80106197:	e9 5e f8 ff ff       	jmp    801059fa <alltraps>
...
8010619e:	6a 4d                	push   $0x4d
  jmp alltraps
801061a0:	e9 55 f8 ff ff       	jmp    801059fa <alltraps>
...
801061a7:	6a 4e                	push   $0x4e
  jmp alltraps
801061a9:	e9 4c f8 ff ff       	jmp    801059fa <alltraps>
...
801061b0:	6a 4f                	push   $0x4f
  jmp alltraps
801061b2:	e9 43 f8 ff ff       	jmp    801059fa <alltraps>
...
801061b9:	6a 50                	push   $0x50
  jmp alltraps
801061bb:	e9 3a f8 ff ff       	jmp    801059fa <alltraps>
...
801061c2:	6a 51                	push   $0x51
  jmp alltraps
801061c4:	e9 31 f8 ff ff       	jmp    801059fa <alltraps>
...
801061cb:	6a 52                	push   $0x52
  jmp alltraps
801061cd:	e9 28 f8 ff ff       	jmp    801059fa <alltraps>
...
801061d4:	6a 53                	push   $0x53
  jmp alltraps
801061d6:	e9 1f f8 ff ff       	jmp    801059fa <alltraps>
...
801061dd:	6a 54                	push   $0x54
  jmp alltraps
801061df:	e9 16 f8 ff ff       	jmp    801059fa <alltraps>
...
801061e6:	6a 55                	push   $0x55
  jmp alltraps
801061e8:	e9 0d f8 ff ff       	jmp    801059fa <alltraps>
...
801061ef:	6a 56                	push   $0x56
  jmp alltraps
801061f1:	e9 04 f8 ff ff       	jmp    801059fa <alltraps>
...
801061f8:	6a 57                	push   $0x57
  jmp alltraps
801061fa:	e9 fb f7 ff ff       	jmp    801059fa <alltraps>
...
80106201:	6a 58                	push   $0x58
  jmp alltraps
80106203:	e9 f2 f7 ff ff       	jmp    801059fa <alltraps>
...
8010620a:	6a 59                	push   $0x59
  jmp alltraps
8010620c:	e9 e9 f7 ff ff       	jmp    801059fa <alltraps>
...
80106213:	6a 5a                	push   $0x5a
  jmp alltraps
80106215:	e9 e0 f7 ff ff       	jmp    801059fa <alltraps>
...
8010621c:	6a 5b                	push   $0x5b
  jmp alltraps
8010621e:	e9 d7 f7 ff ff       	jmp    801059fa <alltraps>
...
80106225:	6a 5c                	push   $0x5c
  jmp alltraps
80106227:	e9 ce f7 ff ff       	jmp    801059fa <alltraps>
...
8010622e:	6a 5d                	push   $0x5d
  jmp alltraps
80106230:	e9 c5 f7 ff ff       	jmp    801059fa <alltraps>
...
80106237:	6a 5e                	push   $0x5e
  jmp alltraps
80106239:	e9 bc f7 ff ff       	jmp    801059fa <alltraps>
...
80106240:	6a 5f                	push   $0x5f
  jmp alltraps
80106242:	e9 b3 f7 ff ff       	jmp    801059fa <alltraps>
...
80106249:	6a 60                	push   $0x60
  jmp alltraps
8010624b:	e9 aa f7 ff ff       	jmp    801059fa <alltraps>
...
80106252:	6a 61                	push   $0x61
  jmp alltraps
80106254:	e9 a1 f7 ff ff       	jmp    801059fa <alltraps>
...
8010625b:	6a 62                	push   $0x62
  jmp alltraps
8010625d:	e9 98 f7 ff ff       	jmp    801059fa <alltraps>
...
80106264:	6a 63                	push   $0x63
  jmp alltraps
80106266:	e9 8f f7 ff ff       	jmp    801059fa <alltraps>
...
8010626d:	6a 64                	push   $0x64
  jmp alltraps
8010626f:	e9 86 f7 ff ff       	jmp    801059fa <alltraps>
...
80106276:	6a 65                	push   $0x65
  jmp alltraps
80106278:	e9 7d f7 ff ff       	jmp    801059fa <alltraps>
...
8010627f:	6a 66                	push   $0x66
  jmp alltraps
80106281:	e9 74 f7 ff ff       	jmp    801059fa <alltraps>
...
80106288:	6a 67                	push   $0x67
  jmp alltraps
8010628a:	e9 6b f7 ff ff       	jmp    801059fa <alltraps>
...
80106291:	6a 68                	push   $0x68
  jmp alltraps
80106293:	e9 62 f7 ff ff       	jmp    801059fa <alltraps>
...
8010629a:	6a 69                	push   $0x69
  jmp alltraps
8010629c:	e9 59 f7 ff ff       	jmp    801059fa <alltraps>
...
801062a3:	6a 6a                	push   $0x6a
  jmp alltraps
801062a5:	e9 50 f7 ff ff       	jmp    801059fa <alltraps>
...
801062ac:	6a 6b                	push   $0x6b
  jmp alltraps
801062ae:	e9 47 f7 ff ff       	jmp    801059fa <alltraps>
...
801062b5:	6a 6c                	push   $0x6c
  jmp alltraps
801062b7:	e9 3e f7 ff ff       	jmp    801059fa <alltraps>
...
801062be:	6a 6d                	push   $0x6d
  jmp alltraps
801062c0:	e9 35 f7 ff ff       	jmp    801059fa <alltraps>
...
801062c7:	6a 6e                	push   $0x6e
  jmp alltraps
801062c9:	e9 2c f7 ff ff       	jmp    801059fa <alltraps>
...
801062d0:	6a 6f                	push   $0x6f
  jmp alltraps
801062d2:	e9 23 f7 ff ff       	jmp    801059fa <alltraps>
...
801062d9:	6a 70                	push   $0x70
  jmp alltraps
801062db:	e9 1a f7 ff ff       	jmp    801059fa <alltraps>
...
801062e2:	6a 71                	push   $0x71
  jmp alltraps
801062e4:	e9 11 f7 ff ff       	jmp    801059fa <alltraps>
...
801062eb:	6a 72                	push   $0x72
  jmp alltraps
801062ed:	e9 08 f7 ff ff       	jmp    801059fa <alltraps>
...
801062f4:	6a 73                	push   $0x73
  jmp alltraps
801062f6:	e9 ff f6 ff ff       	jmp    801059fa <alltraps>
...
801062fd:	6a 74                	push   $0x74
  jmp alltraps
801062ff:	e9 f6 f6 ff ff       	jmp    801059fa <alltraps>
...
80106306:	6a 75                	push   $0x75
  jmp alltraps
80106308:	e9 ed f6 ff ff       	jmp    801059fa <alltraps>
...
8010630f:	6a 76                	push   $0x76
  jmp alltraps
80106311:	e9 e4 f6 ff ff       	jmp    801059fa <alltraps>
...
80106318:	6a 77                	push   $0x77
  jmp alltraps
8010631a:	e9 db f6 ff ff       	jmp    801059fa <alltraps>
...
80106321:	6a 78                	push   $0x78
  jmp alltraps
80106323:	e9 d2 f6 ff ff       	jmp    801059fa <alltraps>
...
8010632a:	6a 79                	push   $0x79
  jmp alltraps
8010632c:	e9 c9 f6 ff ff       	jmp    801059fa <alltraps>
...
80106333:	6a 7a                	push   $0x7a
  jmp alltraps
80106335:	e9 c0 f6 ff ff       	jmp    801059fa <alltraps>
...
8010633c:	6a 7b                	push   $0x7b
  jmp alltraps
8010633e:	e9 b7 f6 ff ff       	jmp    801059fa <alltraps>
...
80106345:	6a 7c                	push   $0x7c
  jmp alltraps
80106347:	e9 ae f6 ff ff       	jmp    801059fa <alltraps>
...
8010634e:	6a 7d                	push   $0x7d
  jmp alltraps
80106350:	e9 a5 f6 ff ff       	jmp    801059fa <alltraps>
...
80106357:	6a 7e                	push   $0x7e
  jmp alltraps
80106359:	e9 9c f6 ff ff       	jmp    801059fa <alltraps>
...
80106360:	6a 7f                	push   $0x7f
  jmp alltraps
80106362:	e9 93 f6 ff ff       	jmp    801059fa <alltraps>
...
80106369:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010636e:	e9 87 f6 ff ff       	jmp    801059fa <alltraps>
...
80106375:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010637a:	e9 7b f6 ff ff       	jmp    801059fa <alltraps>
...
80106381:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106386:	e9 6f f6 ff ff       	jmp    801059fa <alltraps>
...
8010638d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106392:	e9 63 f6 ff ff       	jmp    801059fa <alltraps>
...
80106399:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010639e:	e9 57 f6 ff ff       	jmp    801059fa <alltraps>
...
801063a5:	68 85 00 00 00       	push   $0x85
  jmp alltraps
801063aa:	e9 4b f6 ff ff       	jmp    801059fa <alltraps>
...
801063b1:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801063b6:	e9 3f f6 ff ff       	jmp    801059fa <alltraps>
...
801063bd:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801063c2:	e9 33 f6 ff ff       	jmp    801059fa <alltraps>
...
801063c9:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801063ce:	e9 27 f6 ff ff       	jmp    801059fa <alltraps>
...
801063d5:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801063da:	e9 1b f6 ff ff       	jmp    801059fa <alltraps>
...
801063e1:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801063e6:	e9 0f f6 ff ff       	jmp    801059fa <alltraps>
...
801063ed:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801063f2:	e9 03 f6 ff ff       	jmp    801059fa <alltraps>
...
801063f9:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801063fe:	e9 f7 f5 ff ff       	jmp    801059fa <alltraps>
...
80106405:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010640a:	e9 eb f5 ff ff       	jmp    801059fa <alltraps>
...
80106411:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106416:	e9 df f5 ff ff       	jmp    801059fa <alltraps>
...
8010641d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106422:	e9 d3 f5 ff ff       	jmp    801059fa <alltraps>
...
80106429:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010642e:	e9 c7 f5 ff ff       	jmp    801059fa <alltraps>
...
80106435:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010643a:	e9 bb f5 ff ff       	jmp    801059fa <alltraps>
...
80106441:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106446:	e9 af f5 ff ff       	jmp    801059fa <alltraps>
...
8010644d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106452:	e9 a3 f5 ff ff       	jmp    801059fa <alltraps>
...
80106459:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010645e:	e9 97 f5 ff ff       	jmp    801059fa <alltraps>
...
80106465:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010646a:	e9 8b f5 ff ff       	jmp    801059fa <alltraps>
...
80106471:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106476:	e9 7f f5 ff ff       	jmp    801059fa <alltraps>
...
8010647d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106482:	e9 73 f5 ff ff       	jmp    801059fa <alltraps>
...
80106489:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010648e:	e9 67 f5 ff ff       	jmp    801059fa <alltraps>
...
80106495:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010649a:	e9 5b f5 ff ff       	jmp    801059fa <alltraps>
...
801064a1:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801064a6:	e9 4f f5 ff ff       	jmp    801059fa <alltraps>
...
801064ad:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801064b2:	e9 43 f5 ff ff       	jmp    801059fa <alltraps>
...
801064b9:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801064be:	e9 37 f5 ff ff       	jmp    801059fa <alltraps>
...
801064c5:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801064ca:	e9 2b f5 ff ff       	jmp    801059fa <alltraps>
...
801064d1:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801064d6:	e9 1f f5 ff ff       	jmp    801059fa <alltraps>
...
801064dd:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801064e2:	e9 13 f5 ff ff       	jmp    801059fa <alltraps>
...
801064e9:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801064ee:	e9 07 f5 ff ff       	jmp    801059fa <alltraps>
...
801064f5:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801064fa:	e9 fb f4 ff ff       	jmp    801059fa <alltraps>
...
80106501:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106506:	e9 ef f4 ff ff       	jmp    801059fa <alltraps>
...
8010650d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106512:	e9 e3 f4 ff ff       	jmp    801059fa <alltraps>
...
80106519:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010651e:	e9 d7 f4 ff ff       	jmp    801059fa <alltraps>
...
80106525:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010652a:	e9 cb f4 ff ff       	jmp    801059fa <alltraps>
...
80106531:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106536:	e9 bf f4 ff ff       	jmp    801059fa <alltraps>
...
8010653d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106542:	e9 b3 f4 ff ff       	jmp    801059fa <alltraps>
...
80106549:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010654e:	e9 a7 f4 ff ff       	jmp    801059fa <alltraps>
...
80106555:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010655a:	e9 9b f4 ff ff       	jmp    801059fa <alltraps>
...
80106561:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106566:	e9 8f f4 ff ff       	jmp    801059fa <alltraps>
...
8010656d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106572:	e9 83 f4 ff ff       	jmp    801059fa <alltraps>
...
80106579:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010657e:	e9 77 f4 ff ff       	jmp    801059fa <alltraps>
...
80106585:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010658a:	e9 6b f4 ff ff       	jmp    801059fa <alltraps>
...
80106591:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106596:	e9 5f f4 ff ff       	jmp    801059fa <alltraps>
...
8010659d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801065a2:	e9 53 f4 ff ff       	jmp    801059fa <alltraps>
...
801065a9:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801065ae:	e9 47 f4 ff ff       	jmp    801059fa <alltraps>
...
801065b5:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801065ba:	e9 3b f4 ff ff       	jmp    801059fa <alltraps>
...
801065c1:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801065c6:	e9 2f f4 ff ff       	jmp    801059fa <alltraps>
...
801065cd:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801065d2:	e9 23 f4 ff ff       	jmp    801059fa <alltraps>
...
801065d9:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801065de:	e9 17 f4 ff ff       	jmp    801059fa <alltraps>
...
801065e5:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801065ea:	e9 0b f4 ff ff       	jmp    801059fa <alltraps>
...
801065f1:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801065f6:	e9 ff f3 ff ff       	jmp    801059fa <alltraps>
...
801065fd:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106602:	e9 f3 f3 ff ff       	jmp    801059fa <alltraps>
...
80106609:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010660e:	e9 e7 f3 ff ff       	jmp    801059fa <alltraps>
...
80106615:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010661a:	e9 db f3 ff ff       	jmp    801059fa <alltraps>
...
80106621:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106626:	e9 cf f3 ff ff       	jmp    801059fa <alltraps>
...
8010662d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106632:	e9 c3 f3 ff ff       	jmp    801059fa <alltraps>
...
80106639:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010663e:	e9 b7 f3 ff ff       	jmp    801059fa <alltraps>
...
80106645:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010664a:	e9 ab f3 ff ff       	jmp    801059fa <alltraps>
...
80106651:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106656:	e9 9f f3 ff ff       	jmp    801059fa <alltraps>
...
8010665d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106662:	e9 93 f3 ff ff       	jmp    801059fa <alltraps>
...
80106669:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010666e:	e9 87 f3 ff ff       	jmp    801059fa <alltraps>
...
80106675:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010667a:	e9 7b f3 ff ff       	jmp    801059fa <alltraps>
...
80106681:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106686:	e9 6f f3 ff ff       	jmp    801059fa <alltraps>
...
8010668d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106692:	e9 63 f3 ff ff       	jmp    801059fa <alltraps>
...
80106699:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010669e:	e9 57 f3 ff ff       	jmp    801059fa <alltraps>
...
801066a5:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801066aa:	e9 4b f3 ff ff       	jmp    801059fa <alltraps>
...
801066b1:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801066b6:	e9 3f f3 ff ff       	jmp    801059fa <alltraps>
...
801066bd:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801066c2:	e9 33 f3 ff ff       	jmp    801059fa <alltraps>
...
801066c9:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801066ce:	e9 27 f3 ff ff       	jmp    801059fa <alltraps>
...
801066d5:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801066da:	e9 1b f3 ff ff       	jmp    801059fa <alltraps>
...
801066e1:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801066e6:	e9 0f f3 ff ff       	jmp    801059fa <alltraps>
...
801066ed:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801066f2:	e9 03 f3 ff ff       	jmp    801059fa <alltraps>
...
801066f9:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801066fe:	e9 f7 f2 ff ff       	jmp    801059fa <alltraps>
...
80106705:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010670a:	e9 eb f2 ff ff       	jmp    801059fa <alltraps>
...
80106711:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106716:	e9 df f2 ff ff       	jmp    801059fa <alltraps>
...
8010671d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106722:	e9 d3 f2 ff ff       	jmp    801059fa <alltraps>
...
80106729:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010672e:	e9 c7 f2 ff ff       	jmp    801059fa <alltraps>
...
80106735:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010673a:	e9 bb f2 ff ff       	jmp    801059fa <alltraps>
...
80106741:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106746:	e9 af f2 ff ff       	jmp    801059fa <alltraps>
...
8010674d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106752:	e9 a3 f2 ff ff       	jmp    801059fa <alltraps>
...
80106759:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010675e:	e9 97 f2 ff ff       	jmp    801059fa <alltraps>
...
80106765:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010676a:	e9 8b f2 ff ff       	jmp    801059fa <alltraps>
...
80106771:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106776:	e9 7f f2 ff ff       	jmp    801059fa <alltraps>
...
8010677d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106782:	e9 73 f2 ff ff       	jmp    801059fa <alltraps>
...
80106789:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010678e:	e9 67 f2 ff ff       	jmp    801059fa <alltraps>
...
80106795:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010679a:	e9 5b f2 ff ff       	jmp    801059fa <alltraps>
...
801067a1:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801067a6:	e9 4f f2 ff ff       	jmp    801059fa <alltraps>
...
801067ad:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801067b2:	e9 43 f2 ff ff       	jmp    801059fa <alltraps>
...
801067b9:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801067be:	e9 37 f2 ff ff       	jmp    801059fa <alltraps>
...
801067c5:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801067ca:	e9 2b f2 ff ff       	jmp    801059fa <alltraps>
...
801067d1:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801067d6:	e9 1f f2 ff ff       	jmp    801059fa <alltraps>
...
801067dd:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801067e2:	e9 13 f2 ff ff       	jmp    801059fa <alltraps>
...
801067e9:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801067ee:	e9 07 f2 ff ff       	jmp    801059fa <alltraps>
...
801067f5:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801067fa:	e9 fb f1 ff ff       	jmp    801059fa <alltraps>
...
80106801:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106806:	e9 ef f1 ff ff       	jmp    801059fa <alltraps>
...
8010680d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106812:	e9 e3 f1 ff ff       	jmp    801059fa <alltraps>
...
80106819:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010681e:	e9 d7 f1 ff ff       	jmp    801059fa <alltraps>
...
80106825:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010682a:	e9 cb f1 ff ff       	jmp    801059fa <alltraps>
...
80106831:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106836:	e9 bf f1 ff ff       	jmp    801059fa <alltraps>
...
8010683d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106842:	e9 b3 f1 ff ff       	jmp    801059fa <alltraps>
...
80106849:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010684e:	e9 a7 f1 ff ff       	jmp    801059fa <alltraps>
...
80106855:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010685a:	e9 9b f1 ff ff       	jmp    801059fa <alltraps>
...
80106861:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106866:	e9 8f f1 ff ff       	jmp    801059fa <alltraps>
...
8010686d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106872:	e9 83 f1 ff ff       	jmp    801059fa <alltraps>
...
80106879:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010687e:	e9 77 f1 ff ff       	jmp    801059fa <alltraps>
...
80106885:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010688a:	e9 6b f1 ff ff       	jmp    801059fa <alltraps>
...
80106891:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106896:	e9 5f f1 ff ff       	jmp    801059fa <alltraps>
...
8010689d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
801068a2:	e9 53 f1 ff ff       	jmp    801059fa <alltraps>
...
801068a9:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
801068ae:	e9 47 f1 ff ff       	jmp    801059fa <alltraps>
...
801068b5:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
801068ba:	e9 3b f1 ff ff       	jmp    801059fa <alltraps>
...
801068c1:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
801068c6:	e9 2f f1 ff ff       	jmp    801059fa <alltraps>
...
801068cd:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
801068d2:	e9 23 f1 ff ff       	jmp    801059fa <alltraps>
...
801068d9:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
801068de:	e9 17 f1 ff ff       	jmp    801059fa <alltraps>
...
801068e5:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801068ea:	e9 0b f1 ff ff       	jmp    801059fa <alltraps>
...
801068f1:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801068f6:	e9 ff f0 ff ff       	jmp    801059fa <alltraps>
...
801068fd:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106902:	e9 f3 f0 ff ff       	jmp    801059fa <alltraps>
...
80106909:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010690e:	e9 e7 f0 ff ff       	jmp    801059fa <alltraps>
...
80106915:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010691a:	e9 db f0 ff ff       	jmp    801059fa <alltraps>
...
80106921:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106926:	e9 cf f0 ff ff       	jmp    801059fa <alltraps>
...
8010692d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106932:	e9 c3 f0 ff ff       	jmp    801059fa <alltraps>
...
80106939:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010693e:	e9 b7 f0 ff ff       	jmp    801059fa <alltraps>
...
80106945:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010694a:	e9 ab f0 ff ff       	jmp    801059fa <alltraps>
...
80106951:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106956:	e9 9f f0 ff ff       	jmp    801059fa <alltraps>
...
8010695d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106962:	e9 93 f0 ff ff       	jmp    801059fa <alltraps>
...
80106985:	39 d3                	cmp    %edx,%ebx
80106987:	73 56                	jae    801069df <deallocuvm.part.0+0x6f>
80106989:	89 4d e0             	mov    %ecx,-0x20(%ebp)
8010698c:	89 c6                	mov    %eax,%esi
8010698e:	89 d7                	mov    %edx,%edi
80106990:	eb 12                	jmp    801069a4 <deallocuvm.part.0+0x34>
80106992:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    pte = walkpgdir(pgdir, (char*)a, 0);
    if(!pte)
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
80106998:	83 c2 01             	add    $0x1,%edx
8010699b:	89 d3                	mov    %edx,%ebx
8010699d:	c1 e3 16             	shl    $0x16,%ebx
  for(; a  < oldsz; a += PGSIZE){
801069a0:	39 fb                	cmp    %edi,%ebx
801069a2:	73 38                	jae    801069dc <deallocuvm.part.0+0x6c>
  pde = &pgdir[PDX(va)];
801069a4:	89 da                	mov    %ebx,%edx
801069a6:	c1 ea 16             	shr    $0x16,%edx
  if(*pde & PTE_P){
801069a9:	8b 04 96             	mov    (%esi,%edx,4),%eax
801069ac:	a8 01                	test   $0x1,%al
801069ae:	74 e8                	je     80106998 <deallocuvm.part.0+0x28>
  return &pgtab[PTX(va)];
801069b0:	89 d9                	mov    %ebx,%ecx
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
801069b2:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  return &pgtab[PTX(va)];
801069b7:	c1 e9 0a             	shr    $0xa,%ecx
801069ba:	81 e1 fc 0f 00 00    	and    $0xffc,%ecx
801069c0:	8d 84 08 00 00 00 80 	lea    -0x80000000(%eax,%ecx,1),%eax
    if(!pte)
801069c7:	85 c0                	test   %eax,%eax
801069c9:	74 cd                	je     80106998 <deallocuvm.part.0+0x28>
    else if((*pte & PTE_P) != 0){
801069cb:	8b 10                	mov    (%eax),%edx
801069cd:	f6 c2 01             	test   $0x1,%dl
801069d0:	75 1e                	jne    801069f0 <deallocuvm.part.0+0x80>
  for(; a  < oldsz; a += PGSIZE){
801069d2:	81 c3 00 10 00 00    	add    $0x1000,%ebx
801069d8:	39 fb                	cmp    %edi,%ebx
801069da:	72 c8                	jb     801069a4 <deallocuvm.part.0+0x34>
...
801069df:	8d 65 f4             	lea    -0xc(%ebp),%esp
801069e2:	89 c8                	mov    %ecx,%eax
801069e4:	5b                   	pop    %ebx
801069e5:	5e                   	pop    %esi
801069e6:	5f                   	pop    %edi
801069e7:	5d                   	pop    %ebp
...
801069f6:	74 26                	je     80106a1e <deallocuvm.part.0+0xae>
      kfree(v);
801069f8:	83 ec 0c             	sub    $0xc,%esp
      char *v = P2V(pa);
801069fb:	81 c2 00 00 00 80    	add    $0x80000000,%edx
80106a01:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80106a04:	81 c3 00 10 00 00    	add    $0x1000,%ebx
      kfree(v);
80106a0a:	52                   	push   %edx
80106a0b:	e8 10 bb ff ff       	call   80102520 <kfree>
      *pte = 0;
80106a10:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  for(; a  < oldsz; a += PGSIZE){
80106a13:	83 c4 10             	add    $0x10,%esp
      *pte = 0;
80106a16:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
80106a1c:	eb 82                	jmp    801069a0 <deallocuvm.part.0+0x30>
        panic("kfree");
80106a1e:	83 ec 0c             	sub    $0xc,%esp
80106a21:	68 a6 75 10 80       	push   $0x801075a6
80106a26:	e8 55 99 ff ff       	call   80100380 <panic>
...
80106a58:	eb 3f                	jmp    80106a99 <mappages+0x69>
...
80106a8a:	89 30                	mov    %esi,(%eax)
    if(a == last)
80106a8c:	8b 45 dc             	mov    -0x24(%ebp),%eax
80106a8f:	39 c3                	cmp    %eax,%ebx
80106a91:	74 6d                	je     80106b00 <mappages+0xd0>
    a += PGSIZE;
80106a93:	81 c3 00 10 00 00    	add    $0x1000,%ebx
  for(;;){
80106a99:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  pde = &pgdir[PDX(va)];
80106a9c:	8b 4d e0             	mov    -0x20(%ebp),%ecx
80106a9f:	8d 34 03             	lea    (%ebx,%eax,1),%esi
80106aa2:	89 d8                	mov    %ebx,%eax
80106aa4:	c1 e8 16             	shr    $0x16,%eax
80106aa7:	8d 3c 81             	lea    (%ecx,%eax,4),%edi
  if(*pde & PTE_P){
80106aaa:	8b 07                	mov    (%edi),%eax
80106aac:	a8 01                	test   $0x1,%al
80106aae:	75 b0                	jne    80106a60 <mappages+0x30>
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
80106ab0:	e8 2b bc ff ff       	call   801026e0 <kalloc>
80106ab5:	85 c0                	test   %eax,%eax
80106ab7:	74 37                	je     80106af0 <mappages+0xc0>
    memset(pgtab, 0, PGSIZE);
80106ab9:	83 ec 04             	sub    $0x4,%esp
80106abc:	68 00 10 00 00       	push   $0x1000
80106ac1:	6a 00                	push   $0x0
80106ac3:	50                   	push   %eax
80106ac4:	89 45 d8             	mov    %eax,-0x28(%ebp)
80106ac7:	e8 34 dc ff ff       	call   80104700 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80106acc:	8b 55 d8             	mov    -0x28(%ebp),%edx
  return &pgtab[PTX(va)];
80106acf:	83 c4 10             	add    $0x10,%esp
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80106ad2:	8d 82 00 00 00 80    	lea    -0x80000000(%edx),%eax
80106ad8:	83 c8 07             	or     $0x7,%eax
80106adb:	89 07                	mov    %eax,(%edi)
  return &pgtab[PTX(va)];
80106add:	89 d8                	mov    %ebx,%eax
80106adf:	c1 e8 0a             	shr    $0xa,%eax
80106ae2:	25 fc 0f 00 00       	and    $0xffc,%eax
80106ae7:	01 d0                	add    %edx,%eax
80106ae9:	eb 90                	jmp    80106a7b <mappages+0x4b>
...
80106b0d:	68 04 7c 10 80       	push   $0x80107c04
...
80106b23:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106b26:	e8 a5 ce ff ff       	call   801039d0 <cpuid>
  pd[0] = size-1;
...
80106b3a:	c7 80 98 36 11 80 ff 	movl   $0xffff,-0x7feec968(%eax)
80106b41:	ff 00 00 
80106b44:	c7 80 9c 36 11 80 00 	movl   $0xcf9a00,-0x7feec964(%eax)
80106b4b:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106b4e:	c7 80 a0 36 11 80 ff 	movl   $0xffff,-0x7feec960(%eax)
80106b55:	ff 00 00 
80106b58:	c7 80 a4 36 11 80 00 	movl   $0xcf9200,-0x7feec95c(%eax)
80106b5f:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106b62:	c7 80 a8 36 11 80 ff 	movl   $0xffff,-0x7feec958(%eax)
80106b69:	ff 00 00 
80106b6c:	c7 80 ac 36 11 80 00 	movl   $0xcffa00,-0x7feec954(%eax)
80106b73:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106b76:	c7 80 b0 36 11 80 ff 	movl   $0xffff,-0x7feec950(%eax)
80106b7d:	ff 00 00 
80106b80:	c7 80 b4 36 11 80 00 	movl   $0xcff200,-0x7feec94c(%eax)
80106b87:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
80106b8a:	05 90 36 11 80       	add    $0x80113690,%eax
  pd[1] = (uint)p;
...
80106bb0:	a1 44 63 11 80       	mov    0x80116344,%eax
...
80106be4:	0f 84 c2 00 00 00    	je     80106cac <switchuvm+0xec>
  pushcli();
80106bea:	e8 e1 d8 ff ff       	call   801044d0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106bef:	e8 7c cd ff ff       	call   80103970 <mycpu>
80106bf4:	89 c3                	mov    %eax,%ebx
80106bf6:	e8 75 cd ff ff       	call   80103970 <mycpu>
80106bfb:	89 c7                	mov    %eax,%edi
80106bfd:	e8 6e cd ff ff       	call   80103970 <mycpu>
80106c02:	83 c7 08             	add    $0x8,%edi
80106c05:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106c08:	e8 63 cd ff ff       	call   80103970 <mycpu>
...
80106ceb:	77 49                	ja     80106d36 <inituvm+0x66>
  mem = kalloc();
80106ced:	e8 ee b9 ff ff       	call   801026e0 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106cff:	e8 fc d9 ff ff       	call   80104700 <memset>
...
80106d19:	e8 12 fd ff ff       	call   80106a30 <mappages>
  memmove(mem, init, sz);
80106d1e:	89 75 10             	mov    %esi,0x10(%ebp)
80106d21:	83 c4 10             	add    $0x10,%esp
80106d24:	89 7d 0c             	mov    %edi,0xc(%ebp)
...
80106d30:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106d31:	e9 5a da ff ff       	jmp    80104790 <memmove>
    panic("inituvm: more than a page");
80106d36:	83 ec 0c             	sub    $0xc,%esp
80106d39:	68 49 7c 10 80       	push   $0x80107c49
80106d3e:	e8 3d 96 ff ff       	call   80100380 <panic>
...
80106d59:	8b 75 0c             	mov    0xc(%ebp),%esi
{
80106d5c:	8b 7d 18             	mov    0x18(%ebp),%edi
  if((uint) addr % PGSIZE != 0)
80106d5f:	81 e6 ff 0f 00 00    	and    $0xfff,%esi
80106d65:	0f 85 a2 00 00 00    	jne    80106e0d <loaduvm+0xbd>
  for(i = 0; i < sz; i += PGSIZE){
80106d6b:	85 ff                	test   %edi,%edi
80106d6d:	74 7d                	je     80106dec <loaduvm+0x9c>
80106d6f:	90                   	nop
  pde = &pgdir[PDX(va)];
80106d70:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(*pde & PTE_P){
80106d73:	8b 55 08             	mov    0x8(%ebp),%edx
80106d76:	01 f0                	add    %esi,%eax
  pde = &pgdir[PDX(va)];
80106d78:	89 c1                	mov    %eax,%ecx
80106d7a:	c1 e9 16             	shr    $0x16,%ecx
  if(*pde & PTE_P){
80106d7d:	8b 0c 8a             	mov    (%edx,%ecx,4),%ecx
80106d80:	f6 c1 01             	test   $0x1,%cl
80106d83:	75 13                	jne    80106d98 <loaduvm+0x48>
      panic("loaduvm: address should exist");
80106d85:	83 ec 0c             	sub    $0xc,%esp
80106d88:	68 63 7c 10 80       	push   $0x80107c63
80106d8d:	e8 ee 95 ff ff       	call   80100380 <panic>
80106d92:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  return &pgtab[PTX(va)];
80106d98:	c1 e8 0a             	shr    $0xa,%eax
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80106d9b:	81 e1 00 f0 ff ff    	and    $0xfffff000,%ecx
  return &pgtab[PTX(va)];
80106da1:	25 fc 0f 00 00       	and    $0xffc,%eax
80106da6:	8d 8c 01 00 00 00 80 	lea    -0x80000000(%ecx,%eax,1),%ecx
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80106dad:	85 c9                	test   %ecx,%ecx
80106daf:	74 d4                	je     80106d85 <loaduvm+0x35>
    if(sz - i < PGSIZE)
80106db1:	89 fb                	mov    %edi,%ebx
80106db3:	b8 00 10 00 00       	mov    $0x1000,%eax
80106db8:	29 f3                	sub    %esi,%ebx
80106dba:	39 c3                	cmp    %eax,%ebx
80106dbc:	0f 47 d8             	cmova  %eax,%ebx
    if(readi(ip, P2V(pa), offset+i, n) != n)
80106dbf:	53                   	push   %ebx
80106dc0:	8b 45 14             	mov    0x14(%ebp),%eax
80106dc3:	01 f0                	add    %esi,%eax
80106dc5:	50                   	push   %eax
    pa = PTE_ADDR(*pte);
80106dc6:	8b 01                	mov    (%ecx),%eax
80106dc8:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    if(readi(ip, P2V(pa), offset+i, n) != n)
80106dcd:	05 00 00 00 80       	add    $0x80000000,%eax
80106dd2:	50                   	push   %eax
80106dd3:	ff 75 10             	push   0x10(%ebp)
80106dd6:	e8 05 ad ff ff       	call   80101ae0 <readi>
80106ddb:	83 c4 10             	add    $0x10,%esp
80106dde:	39 d8                	cmp    %ebx,%eax
80106de0:	75 1e                	jne    80106e00 <loaduvm+0xb0>
  for(i = 0; i < sz; i += PGSIZE){
80106de2:	81 c6 00 10 00 00    	add    $0x1000,%esi
80106de8:	39 fe                	cmp    %edi,%esi
80106dea:	72 84                	jb     80106d70 <loaduvm+0x20>
}
...
80106e10:	68 04 7d 10 80       	push   $0x80107d04
...
80106e2e:	0f 88 98 00 00 00    	js     80106ecc <allocuvm+0xac>
80106e34:	89 f2                	mov    %esi,%edx
  if(newsz < oldsz)
80106e36:	3b 75 0c             	cmp    0xc(%ebp),%esi
80106e39:	0f 82 a1 00 00 00    	jb     80106ee0 <allocuvm+0xc0>
  a = PGROUNDUP(oldsz);
80106e3f:	8b 45 0c             	mov    0xc(%ebp),%eax
80106e42:	05 ff 0f 00 00       	add    $0xfff,%eax
80106e47:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106e4c:	89 c7                	mov    %eax,%edi
  for(; a < newsz; a += PGSIZE){
80106e4e:	39 f0                	cmp    %esi,%eax
80106e50:	0f 83 8d 00 00 00    	jae    80106ee3 <allocuvm+0xc3>
80106e56:	89 75 e4             	mov    %esi,-0x1c(%ebp)
80106e59:	eb 44                	jmp    80106e9f <allocuvm+0x7f>
...
80106e6b:	e8 90 d8 ff ff       	call   80104700 <memset>
...
80106e7f:	89 fa                	mov    %edi,%edx
80106e81:	50                   	push   %eax
80106e82:	8b 45 08             	mov    0x8(%ebp),%eax
80106e85:	e8 a6 fb ff ff       	call   80106a30 <mappages>
80106e8a:	83 c4 10             	add    $0x10,%esp
80106e8d:	85 c0                	test   %eax,%eax
80106e8f:	78 5f                	js     80106ef0 <allocuvm+0xd0>
  for(; a < newsz; a += PGSIZE){
80106e91:	81 c7 00 10 00 00    	add    $0x1000,%edi
80106e97:	39 f7                	cmp    %esi,%edi
80106e99:	0f 83 89 00 00 00    	jae    80106f28 <allocuvm+0x108>
    mem = kalloc();
80106e9f:	e8 3c b8 ff ff       	call   801026e0 <kalloc>
...
80106ead:	68 81 7c 10 80       	push   $0x80107c81
80106eb2:	e8 f9 97 ff ff       	call   801006b0 <cprintf>
  if(newsz >= oldsz)
80106eb7:	83 c4 10             	add    $0x10,%esp
80106eba:	3b 75 0c             	cmp    0xc(%ebp),%esi
80106ebd:	74 0d                	je     80106ecc <allocuvm+0xac>
80106ebf:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106ec2:	8b 45 08             	mov    0x8(%ebp),%eax
80106ec5:	89 f2                	mov    %esi,%edx
80106ec7:	e8 a4 fa ff ff       	call   80106970 <deallocuvm.part.0>
    return 0;
80106ecc:	31 d2                	xor    %edx,%edx
}
80106ece:	8d 65 f4             	lea    -0xc(%ebp),%esp
80106ed1:	89 d0                	mov    %edx,%eax
80106ed3:	5b                   	pop    %ebx
80106ed4:	5e                   	pop    %esi
80106ed5:	5f                   	pop    %edi
80106ed6:	5d                   	pop    %ebp
...
80106edf:	90                   	nop
    return oldsz;
80106ee0:	8b 55 0c             	mov    0xc(%ebp),%edx
}
80106ee3:	8d 65 f4             	lea    -0xc(%ebp),%esp
80106ee6:	89 d0                	mov    %edx,%eax
80106ee8:	5b                   	pop    %ebx
80106ee9:	5e                   	pop    %esi
80106eea:	5f                   	pop    %edi
80106eeb:	5d                   	pop    %ebp
...
80106ef3:	68 99 7c 10 80       	push   $0x80107c99
80106ef8:	e8 b3 97 ff ff       	call   801006b0 <cprintf>
  if(newsz >= oldsz)
80106efd:	83 c4 10             	add    $0x10,%esp
80106f00:	3b 75 0c             	cmp    0xc(%ebp),%esi
80106f03:	74 0d                	je     80106f12 <allocuvm+0xf2>
80106f05:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106f08:	8b 45 08             	mov    0x8(%ebp),%eax
80106f0b:	89 f2                	mov    %esi,%edx
80106f0d:	e8 5e fa ff ff       	call   80106970 <deallocuvm.part.0>
      kfree(mem);
80106f12:	83 ec 0c             	sub    $0xc,%esp
80106f15:	53                   	push   %ebx
80106f16:	e8 05 b6 ff ff       	call   80102520 <kfree>
      return 0;
80106f1b:	83 c4 10             	add    $0x10,%esp
    return 0;
80106f1e:	31 d2                	xor    %edx,%edx
80106f20:	eb ac                	jmp    80106ece <allocuvm+0xae>
...
80106f50:	5d                   	pop    %ebp
80106f51:	e9 1a fa ff ff       	jmp    80106970 <deallocuvm.part.0>
...
80106f8b:	e8 e0 f9 ff ff       	call   80106970 <deallocuvm.part.0>
...
80106fbe:	e8 5d b5 ff ff       	call   80102520 <kfree>
...
80106fd3:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106fd4:	e9 47 b5 ff ff       	jmp    80102520 <kfree>
    panic("freevm: no pgdir");
80106fd9:	83 ec 0c             	sub    $0xc,%esp
80106fdc:	68 b5 7c 10 80       	push   $0x80107cb5
...
80106ff5:	e8 e6 b6 ff ff       	call   801026e0 <kalloc>
80106ffa:	85 c0                	test   %eax,%eax
80106ffc:	74 5e                	je     8010705c <setupkvm+0x6c>
  memset(pgdir, 0, PGSIZE);
80106ffe:	83 ec 04             	sub    $0x4,%esp
80107001:	89 c6                	mov    %eax,%esi
...
80107010:	e8 eb d6 ff ff       	call   80104700 <memset>
...
80107023:	ff 73 0c             	push   0xc(%ebx)
80107026:	50                   	push   %eax
80107027:	29 c1                	sub    %eax,%ecx
80107029:	89 f0                	mov    %esi,%eax
8010702b:	e8 00 fa ff ff       	call   80106a30 <mappages>
...
80107054:	e8 17 ff ff ff       	call   80106f70 <freevm>
      return 0;
80107059:	83 c4 10             	add    $0x10,%esp
}
8010705c:	8d 65 f8             	lea    -0x8(%ebp),%esp
    return 0;
8010705f:	31 f6                	xor    %esi,%esi
}
...
8010707b:	a3 44 63 11 80       	mov    %eax,0x80116344
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
801070ac:	68 c6 7c 10 80       	push   $0x80107cc6
...
801070f3:	0f 84 e9 00 00 00    	je     801071e2 <copyuvm+0x102>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
...
80107122:	68 d0 7c 10 80       	push   $0x80107cd0
...
8010715f:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80107165:	e8 76 b5 ff ff       	call   801026e0 <kalloc>
...
8010719b:	e8 90 f8 ff ff       	call   80106a30 <mappages>
...
801071ad:	3b 75 0c             	cmp    0xc(%ebp),%esi
801071b0:	0f 82 5a ff ff ff    	jb     80107110 <copyuvm+0x30>
  return d;
...
801071cc:	e8 4f b3 ff ff       	call   80102520 <kfree>
      goto bad;
...
801071df:	83 c4 10             	add    $0x10,%esp
    return 0;
801071e2:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
}
...
801071f7:	68 ea 7c 10 80       	push   $0x80107cea
...
80107296:	29 c3                	sub    %eax,%ebx
80107298:	81 c3 00 10 00 00    	add    $0x1000,%ebx
8010729e:	39 f3                	cmp    %esi,%ebx
801072a0:	0f 47 de             	cmova  %esi,%ebx
    if(n > len)
      n = len;
    memmove(pa0 + (va - va0), buf, n);
801072a3:	29 f8                	sub    %edi,%eax
801072a5:	83 ec 04             	sub    $0x4,%esp
801072a8:	01 c1                	add    %eax,%ecx
801072aa:	53                   	push   %ebx
801072ab:	52                   	push   %edx
801072ac:	89 55 10             	mov    %edx,0x10(%ebp)
801072af:	51                   	push   %ecx
801072b0:	e8 db d4 ff ff       	call   80104790 <memmove>
    len -= n;
    buf += n;
