...
00000670 <writetest1>:
{
  ...
  for(i = 0; i < MAXFILE; i++){
     ...
     6da:	81 fb 8b 40 00 00    	cmp    $0x408b,%ebx
  ...
  n = 0;
    ...
    if(i == 0){
     ...
     73f:	75 cf                	jne    710 <writetest1+0xa0>
      if(n == MAXFILE - 1){
     741:	81 fe 8a 40 00 00    	cmp    $0x408a,%esi
  ...
  printf(stdout, "big files ok\n");
     ...
     7d3:	52                   	push   %edx
     7d4:	68 8a 40 00 00       	push   $0x408a
...
000032a0 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    3313:	50                   	push   %eax
    args[MAXARG-1] = 0;
    3314:	31 c9                	xor    %ecx,%ecx
    printf(stdout, "bigarg test\n");
    3316:	50                   	push   %eax
    3317:	68 40 4c 00 00       	push   $0x4c40
    331c:	ff 35 08 5e 00 00    	push   0x5e08
    args[MAXARG-1] = 0;
    3322:	89 0d bc a5 00 00    	mov    %ecx,0xa5bc
    printf(stdout, "bigarg test\n");
...
memmove(void *vdst, const void *vsrc, int n)
{
    ...
    3883:	57                   	push   %edi
    3884:	8b 45 10             	mov    0x10(%ebp),%eax
    3887:	8b 55 08             	mov    0x8(%ebp),%edx
    388a:	56                   	push   %esi
